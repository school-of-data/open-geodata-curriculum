...
<img src="/open-geodata-curriculum/images/en/philippines/module0/media/true-size-of.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "True Size of Countries" />
...
<table>
    <tr>
      <td>
        <img src="/open-geodata-curriculum/images/en/philippines/module0/media/blue-marble.jpg" style={{ width: "80%" }} 
        />
      ...
      <td>
        <img src="/open-geodata-curriculum/images/en/philippines/module0/media/globe.jpg" style={{ width: "80%" }} />
...
<img src="/open-geodata-curriculum/images/en/philippines/module0/media/dalandan.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "The earth as an orange" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module0/media/conformal.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Conformal map projection" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module0/media/authalic.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Equal-area map projection" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module0/media/equidistant.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Equidistant map projection" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module0/media/az-equidistant.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Azimuthal equidistant map projection" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module0/media/cylinder.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Cylinder as a developable surface" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module0/media/cone.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Cone as a developable surface" />

Figure 0.8. Conic projections have straight meridians going to one point at the poles. The parallels are arcs.


<img src="/open-geodata-curriculum/images/en/philippines/module0/media/plane.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Plane as a developable surface" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module0/media/aspects.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Aspects of a map projection" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module0/media/spatial-model.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Spatial data modelling reality" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module0/media/raster.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Raster data model" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module0/media/vector.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Vector data model" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module0/media/foss4g-stack.jpeg" style={{ width: "100%", maxwidth: "75vw" }} alt= "Free and Open Source Software for Geospatial (FOSS4G) applications stack" />
