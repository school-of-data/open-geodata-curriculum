...
![Map of Bogota, Columbia in the style of Starry Starry Night](/open-geodata-curriculum/images/en/philippines/module1/media/sample-1.jpg "Map of Bogota, Columbia in the style of Starry Starry Night")
...
![Storm trace data between 1851 to 2020](/open-geodata-curriculum/images/en/philippines/module1/media/sample-2.jpg "Storm trace data between 1851 to 2020")


This next one ([https://flic.kr/p/FA9TiR](https://flic.kr/p/FA9TiR)) is a map of Kerguelen Island by Heinrich Lingnau Schneider.

![Map of Kerguelen Island](/open-geodata-curriculum/images/en/philippines/module1/media/sample-3.jpg "Map of Kerguelen Island")
...
![Field goal attempts and points scored in UAAP Season 81](/open-geodata-curriculum/images/en/philippines/module1/media/sample-4.jpg "Field goal attempts and points scored in UAAP Season 81")
...
![QGIS Map Showcase](/open-geodata-curriculum/images/en/philippines/module1/media/qgis-map-showcase.png "QGIS Map Showcase")
...
![The QGIS interface](/open-geodata-curriculum/images/en/philippines/module1/media/qgis-interface.png "The QGIS interface")
...
![Parts of the QGIS Interface](/open-geodata-curriculum/images/en/philippines/module1/media/qgis-interface-parts.png "Parts of the QGIS Interface")
...
![QGIS interface with some customizations](/open-geodata-curriculum/images/en/philippines/module1/media/qgis-interface-custom.png "QGIS interface with some customizations")
...
![Open QGIS and click on View menu](/open-geodata-curriculum/images/en/philippines/module1/media/ex01-01.png "Open QGIS and click on View menu")

3. Observe the **Panels** menu


![Observe the Panels menu](/open-geodata-curriculum/images/en/philippines/module1/media/ex01-02.png "Observe the Panels menu")

4. Observe the **Toolbars** menu


![Observe the Toolbars menu](/open-geodata-curriculum/images/en/philippines/module1/media/ex01-03.png "Observe the Toolbars menu")
...
1. True or False:
    ...
    2. You can show or hide panels and toolbars
...
![Manage and Install Plugins menu](/open-geodata-curriculum/images/en/philippines/module1/media/plugins-menu.png "Manage and Install Plugins menu")
...
![Manage and Install Plugins dialog](/open-geodata-curriculum/images/en/philippines/module1/media/manage-and-install-plugins-dialog.png "Manage and Install Plugins dialog")
...
![Open Manage and Install Plugins dialog](/open-geodata-curriculum/images/en/philippines/module1/media/plugins-menu-2.png "Open Manage and Install Plugins dialog")
...
![Install Memory Layer Saver plugin](/open-geodata-curriculum/images/en/philippines/module1/media/memory-layer-saver-plugin.png "Install Memory Layer Saver plugin")

   - QuickOSM

![Install QuickOSM plugin](/open-geodata-curriculum/images/en/philippines/module1/media/quickosm-plugin.png "Install QuickOSM plugin")
...
![The System Settings](/open-geodata-curriculum/images/en/philippines/module1/media/settings-1.png "The System Settings")

Figure 1.7. The System Settings


![Project Settings](/open-geodata-curriculum/images/en/philippines/module1/media/settings-2.png "Project Settings")
...
![General Settings of QGIS](/open-geodata-curriculum/images/en/philippines/module1/media/change-theme.png "General Settings of QGIS")
...
![Accessing User Profiles](/open-geodata-curriculum/images/en/philippines/module1/media/user-profiles-1.png "Accessing User Profiles")
...
![alt_text](/open-geodata-curriculum/images/en/philippines/module1/media/user-profiles-2.png "image_tooltip")

2. Give your new user profile a name.


![alt_text](/open-geodata-curriculum/images/en/philippines/module1/media/user-profiles-3.png "image_tooltip")
