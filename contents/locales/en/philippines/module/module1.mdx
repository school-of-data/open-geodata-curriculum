...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/sample-1.jpg" style={{ width: "100%", maxwidth: "75vw" }} alt= "Map of Bogota, Columbia in the style of Starry Starry Night" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/sample-2.jpg" style={{ width: "100%", maxwidth: "75vw" }} alt= "Storm trace data between 1851 to 2020" />


This next one ([https://flic.kr/p/FA9TiR](https://flic.kr/p/FA9TiR)) is a map of Kerguelen Island by Heinrich Lingnau Schneider.

<img src="/open-geodata-curriculum/images/en/philippines/module1/media/sample-3.jpg" style={{ width: "100%", maxwidth: "75vw" }} alt= "Map of Kerguelen Island" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/sample-4.jpg" style={{ width: "100%", maxwidth: "75vw" }} alt= "Field goal attempts and points scored in UAAP Season 81" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/qgis-map-showcase.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "QGIS Map Showcase" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/qgis-interface.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "The QGIS interface" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/qgis-interface-parts.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Parts of the QGIS Interface" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/qgis-interface-custom.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "QGIS interface with some customizations" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/ex01-01.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Open QGIS and click on View menu" />

3. Observe the **Panels** menu


<img src="/open-geodata-curriculum/images/en/philippines/module1/media/ex01-02.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Observe the Panels menu" />

4. Observe the **Toolbars** menu


<img src="/open-geodata-curriculum/images/en/philippines/module1/media/ex01-03.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Observe the Toolbars menu" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/plugins-menu.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Manage and Install Plugins menu" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/manage-and-install-plugins-dialog.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Manage and Install Plugins dialog" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/plugins-menu-2.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Open Manage and Install Plugins dialog" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/memory-layer-saver-plugin.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Install Memory Layer Saver plugin" />

   - QuickOSM

<img src="/open-geodata-curriculum/images/en/philippines/module1/media/quickosm-plugin.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Install QuickOSM plugin" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/settings-1.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "The System Settings" />

Figure 1.7. The System Settings


<img src="/open-geodata-curriculum/images/en/philippines/module1/media/settings-2.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Project Settings" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/change-theme.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "General Settings of QGIS" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/user-profiles-1.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Accessing User Profiles" />
...
<img src="/open-geodata-curriculum/images/en/philippines/module1/media/user-profiles-2.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "image_tooltip" />

2. Give your new user profile a name.


<img src="/open-geodata-curriculum/images/en/philippines/module1/media/user-profiles-3.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "image_tooltip" />
