...
![alt_text](/okf-open-geodata-curriculum/images/en/philippines/module4/media/layer-styling.png "image_tooltip")
...
![alt_text](/okf-open-geodata-curriculum/images/en/philippines/module4/media/style-vector.png "image_tooltip")

![alt_text](/okf-open-geodata-curriculum/images/en/philippines/module4/media/style-raster.png "image_tooltip")
...
2. Add the two vector layers into qgis; Click the Add vector layer button ![alt_text](/okf-open-geodata-curriculum/images/en/philippines/module4/media/add-vector.png "image_tooltip") or use the browser panel. 
...
![Default render](/okf-open-geodata-curriculum/images/en/philippines/module4/media/default-vector-render.png "Default render")
...
![No fill rendering for the polygon](/okf-open-geodata-curriculum/images/en/philippines/module4/media/no-fill-render.png "No fill rendering for the polygon")
...
![Layer Properties dialogue](/okf-open-geodata-curriculum/images/en/philippines/module4/media/vector-style.png "Layer Properties dialogue")

Figure 4.5: Layer Properties dialogue

10. The resulting map should look as below

![Final vector render](/okf-open-geodata-curriculum/images/en/philippines/module4/media/final-vector-render.png "Final vector render")
...
![Symbology menu](/okf-open-geodata-curriculum/images/en/philippines/module4/media/qgis9.png  "Symbology menu")
...
![Population density of Pampanga Province, Philippines](/okf-open-geodata-curriculum/images/en/philippines/module4/media/hrsl-style.png "Population density of Pampanga Province, Philippines")

Figure 4.8: Population density of Pampanga Province, Philippines

5.  Zoom in to see the new map in finer detail.

![Zoomed-in map](/okf-open-geodata-curriculum/images/en/philippines/module4/media/zoom-in.png "Zoomed-in map")
...
![The expected initial workspace](/okf-open-geodata-curriculum/images/en/philippines/module4/media/initial-workspace.png "The expected initial workspace")
...
At the bottom of the Symbology menu, there’s a checkbox for Draw effects. Let’s enable that, and then click the customise effects button ![alt_text](/okf-open-geodata-curriculum/images/en/philippines/module4/media/customise-effects-button.png "image_tooltip") to its right:

![Layer Properties window and Symbology menu](/okf-open-geodata-curriculum/images/en/philippines/module4/media/draw-effects.png "Layer Properties window and Symbology menu")

Figure 4.11: Layer Properties window and Symbology menu

3. A new Effects Properties dialog opens

![Effects properties dialogue](/okf-open-geodata-curriculum/images/en/philippines/module4/media/new-effects-dialog.png "Effects properties dialogue")
...
![Select effect type as blur](/okf-open-geodata-curriculum/images/en/philippines/module4/media/blur-effect.png "Select effect type as blur")
...
![Blurry layer](/okf-open-geodata-curriculum/images/en/philippines/module4/media/blurry-result.png "Blurry layer")
...
![Effects properties dialogue](/okf-open-geodata-curriculum/images/en/philippines/module4/media/drop-shadow.png "Effects properties dialogue")
...
![Drop shadow effect](/okf-open-geodata-curriculum/images/en/philippines/module4/media/drop-shadow-result.png "Drop shadow effect")
...
![Centroid operation on administrative boundary layer](/okf-open-geodata-curriculum/images/en/philippines/module4/media/centroid.png "Centroid operation on administrative boundary layer")
...
![Point layer](/okf-open-geodata-curriculum/images/en/philippines/module4/media/centroid-result.png "Point layer")
