...
![Several polygons](/okf-open-geodata-curriculum/images/en/philippines/module6/media/many-polygons.png "Several polygons")

Figure 6.1: Several polygons


2. The next step is to explore the attribute table interface. Open the attribute table by **Right-clicking on the layer on the Layers Panel ‣ Open Attribute Table**. You can also click the **Open Attribute Table button** ![Open attribute table button](/okf-open-geodata-curriculum/images/en/philippines/module6/media/open-attribute-btn.png "Open attribute table button") from the Attributes Toolbar. This is what the attribute table looks like. The tool bar has a range of buttons, hover over each button to see the embedded functionality.

![Open attribute table](/okf-open-geodata-curriculum/images/en/philippines/module6/media/attribute-tab.png "Open attribute table")

Figure 6.2: Open attribute table

If you don't want the attribute table to be a floating window but rather dock it on the QGIS interface, you can click the **Dock attribute table button** !["Dock attribute table"](/okf-open-geodata-curriculum/images/en/philippines/module6/media/dock-attr-btn.png "Dock attribute table"). When docked, attribute tables will appear as tabs instead of individual windows.

![Docked attribute table](/okf-open-geodata-curriculum/images/en/philippines/module6/media/docked-attribute-tab.png "Docked attribute table")
...
![Field calculator dialogue](/okf-open-geodata-curriculum/images/en/philippines/module6/media/fieldcalc.png "Field calculator dialogue")
...
![New attribute table with new field and attributes](/okf-open-geodata-curriculum/images/en/philippines/module6/media/area.png "New attribute table with new field and attributes")
...
![Add different layers](/okf-open-geodata-curriculum/images/en/philippines/module6/media/add-layers.png "Add different layers")
...
![alt_text](/okf-open-geodata-curriculum/images/en/philippines/module6/media/select.png "image_tooltip")
...
![alt_text](/okf-open-geodata-curriculum/images/en/philippines/module6/media/selected-canvas.png "image_tooltip")

Figure 6.9: Selected clinic/feature is highlighted (yellow)


![alt_text](/okf-open-geodata-curriculum/images/en/philippines/module6/media/selected-attr.png "image_tooltip")
