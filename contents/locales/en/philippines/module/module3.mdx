...
title: philippines
language: english
description: Module 3 - Introduction to OpenStreetMap and the High Resolution Settlement Layer (Philippines, English)
date: ""
author: Ben Hur
...
![OpenStreetMap website](/open-geodata-curriculum/images/en/philippines/module3/media/osm.png "OpenStreetMap website")
...
![Pampanga layers loaded in QGIS](/open-geodata-curriculum/images/en/philippines/module3/media/quickosm-1.png "Pampanga layers loaded in QGIS")
...
![QuickOSM plugin](/open-geodata-curriculum/images/en/philippines/module3/media/quickosm-2.png "QuickOSM plugin")
...
![Load all highways in the Pampanga_SanFernando layer extent](/open-geodata-curriculum/images/en/philippines/module3/media/quickosm-3.png "Load all highways in the Pampanga_SanFernando layer extent")
...
![Highway data loaded from OSM](/open-geodata-curriculum/images/en/philippines/module3/media/quickosm-4.png "Highway data loaded from OSM")
...
![The Overpass query version of the Quick query to load highways](/open-geodata-curriculum/images/en/philippines/module3/media/quickosm-5.png "The Overpass query version of the Quick query to load highways")
...
![Load amenities (points) tagged as fast_food in the Pampanga_province layer extent](/open-geodata-curriculum/images/en/philippines/module3/media/quickosm-6.png "Load amenities (points) tagged as fast_food in the Pampanga_province layer extent")
...
![Fast food locations loaded from OSM](/open-geodata-curriculum/images/en/philippines/module3/media/quickosm-7.png "Fast food locations loaded from OSM")
...
![HRSL data on HDX](/open-geodata-curriculum/images/en/philippines/module3/media/hdx.png "HRSL data on HDX")
...
![The HRSL for Pampanga, Philippines](/open-geodata-curriculum/images/en/philippines/module3/media/hrsl-1.png "The HRSL for Pampanga, Philippines")
...
![QuickOSM parameters for loading fast foods in Pampanga](/open-geodata-curriculum/images/en/philippines/module3/media/quickosm-6.png "QuickOSM parameters for loading fast foods in Pampanga")

Quick query to load all amenities tagged as fast food

2. Click Show query.

![Overpass version of the query](/open-geodata-curriculum/images/en/philippines/module3/media/overpass-1.png "Overpass version of the query")
...
![Overpass query to load only fast foods named Jollibee](/open-geodata-curriculum/images/en/philippines/module3/media/overpass-2.png "Overpass query to load only fast foods named Jollibee")
...
![Amenities tagged as fast food whose name is Jollibee loaded from OSM](/open-geodata-curriculum/images/en/philippines/module3/media/overpass-3.png "Amenities tagged as fast food whose name is Jollibee loaded from OSM")
