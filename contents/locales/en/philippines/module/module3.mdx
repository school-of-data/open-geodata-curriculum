...
![OpenStreetMap website](/okf-open-geodata-curriculum/images/en/philippines/module3/media/osm.png "OpenStreetMap website")
...
![Pampanga layers loaded in QGIS](/okf-open-geodata-curriculum/images/en/philippines/module3/media/quickosm-1.png "Pampanga layers loaded in QGIS")
...
![QuickOSM plugin](/okf-open-geodata-curriculum/images/en/philippines/module3/media/quickosm-2.png "QuickOSM plugin")
...
![Load all highways in the Pampanga_SanFernando layer extent](/okf-open-geodata-curriculum/images/en/philippines/module3/media/quickosm-3.png "Load all highways in the Pampanga_SanFernando layer extent")
...
![Highway data loaded from OSM](/okf-open-geodata-curriculum/images/en/philippines/module3/media/quickosm-4.png "Highway data loaded from OSM")
...
![The Overpass query version of the Quick query to load highways](/okf-open-geodata-curriculum/images/en/philippines/module3/media/quickosm-5.png "The Overpass query version of the Quick query to load highways")
...
![Load amenities (points) tagged as fast_food in the Pampanga_province layer extent](/okf-open-geodata-curriculum/images/en/philippines/module3/media/quickosm-6.png "Load amenities (points) tagged as fast_food in the Pampanga_province layer extent")
...
![Fast food locations loaded from OSM](/okf-open-geodata-curriculum/images/en/philippines/module3/media/quickosm-7.png "Fast food locations loaded from OSM")
...
![HRSL data on HDX](/okf-open-geodata-curriculum/images/en/philippines/module3/media/hdx.png "HRSL data on HDX")
...
![The HRSL for Pampanga, Philippines](/okf-open-geodata-curriculum/images/en/philippines/module3/media/hrsl-1.png "The HRSL for Pampanga, Philippines")
...
![QuickOSM parameters for loading fast foods in Pampanga](/okf-open-geodata-curriculum/images/en/philippines/module3/media/quickosm-6.png "QuickOSM parameters for loading fast foods in Pampanga")

Quick query to load all amenities tagged as fast food

2. Click Show query.

![Overpass version of the query](/okf-open-geodata-curriculum/images/en/philippines/module3/media/overpass-1.png "Overpass version of the query")
...
![Overpass query to load only fast foods named Jollibee](/okf-open-geodata-curriculum/images/en/philippines/module3/media/overpass-2.png "Overpass query to load only fast foods named Jollibee")
...
![Amenities tagged as fast food whose name is Jollibee loaded from OSM](/okf-open-geodata-curriculum/images/en/philippines/module3/media/overpass-3.png "Amenities tagged as fast food whose name is Jollibee loaded from OSM")
