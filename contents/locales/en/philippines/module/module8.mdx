...
![Getting from point A to B using Openstreetmap](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig81.png "Getting from point A to B using Openstreetmap")
...
![Vector lines representing streets and the associated attribute table](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig82.png "Vector lines representing streets and the associated attribute table")
...
![vector data with attribute table](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig83.png "vector data with attribute table")
...
![elements of a geoprocessing operation](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig84.png "elements of a geoprocessing operation")
...
![Loaded vector data sets: points, line and polygons](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig85.png "Loaded vector data sets: points, line and polygons")
...
![Specifications of the coordinate reference system used in the QGIS project](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig86.png "Specifications of the coordinate reference system used in the QGIS project")
...
![Basics statistics for fields](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig87.png "Basics statistics for fields")
...
![Preparing to run basics statistics for roads layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig88.png "Preparing to run basics statistics for roads layer")
...
![Topology checker plugin](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig89_a.png "Topology checker plugin")

Figure 8.9.a - Topology checker plugin

To show the Topology Checker, enable it as a panel under **View ‣ Panels ‣ Topology Checker** (figure 8.9.b). If it does not appear in the Panels menu, you can enable it by clicking the Topology Checker button ![Topology checker button](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig89_btn.png "Topology checker button") on the Plugins toolbar. Once activated it’s window looks like in figure 8.9.c.  


![Topology checker panel](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig89_b.png "Topology checker panel")

Figure 8.9.b - Topology checker panel


![Topology checker window](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig89_c.png "Topology checker window")

Figure 8.9.c - Topology checker window


To define the topology rules, click on the third icon ![Topology rule settings button](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig810_btn.png "Topology rule settings button"), opening a window as in figure 8.10. 


![Topology rule settings window](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig810.png "Topology rule settings window")
...
![Topology rules dropdown menu based on the selected layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig811.png "Topology rules dropdown menu based on the selected layer")
...
![Topology rules to be set](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig812.png "Topology rules to be set")

Figure 8.12 - Topology rules to be set 

Click on the first icon ![Validate rules button](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig813_btn.png "Validate rules button") on the Topology Checker window to run and wait for the results. After running the topology check, your map windows should look like in figure 8.13. 


![Topology check results](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig813.png "Topology check results")
...
![Duplicate point error in points of interest vector layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig814.png "sDuplicate point error in points of interest vector layer")
...
![ Delete duplicate geometries on layer points of interest](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig815.png " Delete duplicate geometries on layer points of interest")
...
![Result of running delete duplicate geometries](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig816.png "Result of running delete duplicate geometries")
...
![Topology check on the buildings vector layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig817_a.png "Topology check on the buildings vector layer")
...
![Results of topology check on the buildings vector layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig817_b.png "Results of topology check on the buildings vector layer")
...
![Remove duplicate geometries on the buildings vector layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig818_a.png "Remove duplicate geometries on the buildings vector layer")

Figure 8.18a - Remove duplicate geometries on the buildings vector layer


![Results of remove duplicate geometries on the buildings vector layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig818_b.png "Results of remove duplicate geometries on the buildings vector layer")

![Results of Delete duplicate geometries](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig818_c.png "Results of Delete duplicate geometries")
...
![List unique values in a vector layer functionality](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig819_a.png "List unique values in a vector layer functionality")
...
![List unique values in a vector layer functionality (Batch Processing)](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig819_b.png "List unique values in a vector layer functionality (Batch Processing)")
...
![GroupStats plugin](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig820_a.png "GroupStats plugin")
...
![GroupStats window](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig820_b.png "GroupStats window")
...
![Running GroupStats on the building layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig821.png "Running GroupStats on the building layer")
...
![Running GroupStats on the roads layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig822.png "Running GroupStats on the roads layer")
...
![Setting the parameters for a 500 m buffer around the places of worship](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig823.png "Setting the parameters for a 500 m buffer around the places of worship")
...
![Running buffer on a point vector layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig824.png "Running buffer on a point vector layer")
...
![Calculate area for the newly obtained layer, then calculate using GroupStats the total sum](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig825.png "Running buffer on Calculate area for the newly obtained layer, then calculate using GroupStats the total sum point vector layer")
...
![Figure 8.26a - Select landuse fclass = industrial](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig826_a.png "Figure 8.26a - Select landuse fclass = industrial")

Figure 8.26a - Select landuse fclass = industrial. 


![Reduced selection of a few buildings and industrial landuse, so the computation can finish faster](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig826_b.png "Reduced selection of a few buildings and industrial landuse, so the computation can finish faster")
...
![Running the Clip algorithm](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig827_a.png "Running the Clip algorithm")
...
![Results of the clip functionality](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig827_b.png "Results of the clip functionality")
...
![Filtering the poi layer to get all schools](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig828_a.png "Filtering the poi layer to get all schools")

Figure 8.28a - Filtering the poi layer to get all schools


![All schools in the poi layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig828_b.png "All schools in the poi layer")

Figure 8.28b - All schools in the poi layer


![Running the Voronoi polygon algorithm](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig828_c.png "Running the Voronoi polygon algorithm")

Figure 8.28c - Running the Voronoi polygon algorithm


![Results of applying Thiessen (Voronoi) polygons algorithm to a point vector layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig828_d.png "Results of applying Thiessen (Voronoi) polygons algorithm to a point vector layer")
...
![Creating a 10X10km vector grid for the Pampanga province](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig829_a.png "Creating a 10X10km vector grid for the Pampanga province")
...
![10X10km vector grid for the Pampanga province](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig829_b.png "10X10km vector grid for the Pampanga province")
...
![Filtering green areas and built-up space in Pampanga](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig830_a.png "Filtering green areas and built-up space in Pampanga ")

Figure 8.30a - Filtering green areas and built-up space in Pampanga 


![Spatial distribution of the green areas and built-up space in Pampanga](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig830_b.png "Spatial distribution of the green areas and built-up space in Pampanga")
...
![Parameters for the intersect algorithm](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig831.png "Parameters for the intersect algorithm")

Figure 8.31 - Parameters for the intersect algorithm

The result should look like in figure 8.32.

![Result of running the intersection algorithm to clip the landuse vector polygons to the grid layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig832.png "Result of running the intersection algorithm to clip the landuse vector polygons to the grid layer")
...
![Landuse features clipped per each grid cell and it's associated attribute table](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig833.png "Landuse features clipped per each grid cell and it's associated attribute table")
...
![Selecting the green spaces](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig834_a.png "Selecting the green spaces")

Figure 8.34a - Selecting the green spaces.


![Selected green spaces](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig834_b.png "Selected green spaces")

Figure 8.34b - Selected green spaces.


![Green and Built-up spaces](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig834_c.png "Green and Built-up spaces")
...
![Computing the area of each feature](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig834_d.png "Computing the area of each feature")

Figure 8.34d - Computing the area of each feature.

![GroupStat parameters setup to sum up the green areas per each 10X10km grid cell](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig834_e.png "GroupStat parameters setup to sum up the green areas per each 10X10km grid cell")
...
![Loading green_spaces_gridded CSV](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig835_a.png "Loading green_spaces_gridded CSV")

Figure 8.35a - Loading green_spaces_gridded CSV


![The green_spaces_gridded CSV attribute table](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig835_b.png "The green_spaces_gridded CSV attribute table")
...
In the **Join** window, push on the green plus button below ![Add join layer button](/okf-open-geodata-curriculum/images/en/philippines/module8/media/add_join_btn.png "Add join layer button") and set the parameters like in figure 8.35, for green spaces.


![Setting the parameters to join by common field grid_id/id the sums of green and built-up spaces for each grid cell - 10X10km unit](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig835_c.png "Setting the parameters to join by common field grid_id/id the sums of green and built-up spaces for each grid cell - 10X10km unit")
...
![Green and built-up CSV joined to Grid](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig836_a.png "Green and built-up CSV joined to Grid")

Figure 8.36a - Green and built-up CSV joined to Grid. 


![Attribute table of the grid10km vector layer containing the total areas for green and built-up spaces](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig836_b.png "Attribute table of the grid10km vector layer containing the total areas for green and built-up spaces")
...
![Percentage of green area in the 10km x 10km grid](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig837_a.png "Percentage of green area in the 10km x 10km grid")

Figure 8.37a - Percentage of green area in the 10km x 10km grid


![Computed percentage of green and built-up area](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig837_b.png "Computed percentage of green and built-up area")

Figure 8.37b - Computed percentage of green and built-up area


![Computing for the ratio of green and built-up areas](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig837_c.png "Computing for the ratio of green and built-up areas")

Figure 8.37c - Computing for the ratio of green and built-up areas


![Computed ratio of green and built-up areas](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig837_d.png "Computed ratio of green and built-up areas")

Figure 8.37d - Computed ratio of green and built-up areas


![Ratio of green and built-up areas in the 10km x 10km grid](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig837_e.png "Ratio of green and built-up areas in the 10km x 10km grid")
...
![Sum Line Lengths parameters](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig838_a.png "Sum Line Lengths parameters")

Figure 8.38a - Sum Line Lengths parameters


![Road lengths and counts per Grid cell](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig838_b.png "Road lengths and counts per Grid cell")

Figure 8.38b - Road lengths and counts per Grid cell


![Spatial distribution of 10X10km units with most roads](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig838_c.png "Spatial distribution of 10X10km units with most roads")
...
![Spatial distribution of 10X10km units with most waterways](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig839.png "Spatial distribution of 10X10km units with most waterway")
...
![Selecting public POIs](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig840_a.png "Selecting public POIs")

Figure 8.40a - Selecting public POIs


![Selected public POIS](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig840_b.png "Selected public POIS")
...
![Count public POIS in each 10km x 10km grid](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig840_c.png "Count public POIS in each 10km x 10km grid")

Figure 8.40c - Count public POIS in each 10km x 10km grid


![Spatial distribution of public POIs density per unit 10X10km](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig840_d.png "Spatial distribution of public POIs density per unit 10X10km")
...
![Interpolation methods available in QGIS](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig841.png "Interpolation methods available in QGIS")
...
![Creating random points inside a polygon layer](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig842.png "Creating random points inside a polygon layer")
...
![Point data layer - randomly created within specified polygons](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig843.png "Point data layer - randomly created within specified polygons")
...
![Creating random values within specified limits](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig844.png "Creating random values within specified limits")
...
![Fictitious precipitation data for the 93 fictitious meteo stations in Pampanga province](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig845.png "Fictitious precipitation data for the 93 fictitious meteo stations in Pampanga province")
...
![Setting up the batch processing window to interpolate the precipitation values for all 7 days](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig846.png "Setting up the batch processing window to interpolate the precipitation values for all 7 days")
...
![Interpolated datasets](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig847.png "Interpolated datasets")
...
![Setting temporal information to the raster dataset (1)](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig848_a.png "Setting temporal information to the raster dataset (1)")


![Setting temporal information to the raster dataset (2)](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig848_b.png "Setting temporal information to the raster dataset (2)")


![Setting temporal information to the raster dataset (7)](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig848_c.png "Setting temporal information to the raster dataset (7)")
...
![Set the parameters of the Time Controller Panel](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig849.png "Set the parameters of the Time Controller Panel")

Figure 8.49 - Set the parameters of the Time Controller Panel. 

Click on the play button ![Play button](/okf-open-geodata-curriculum/images/en/philippines/module8/media/play-btn.png "Play button") and see how the values change. You can choose what other layers to be visible. In figure 8.50, we added the buildings vector layer. 


![Selecting other layers to be visible in the temporal animation](/okf-open-geodata-curriculum/images/en/philippines/module8/media/fig850.png "Selecting other layers to be visible in the temporal animation")
