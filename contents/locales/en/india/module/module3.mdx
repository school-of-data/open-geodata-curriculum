...
title: india
language: english
description: Module 3 - OpenStreetMap and the High Resolution Settlement Layer (India, English)
date: ""
author: Ben Hur
prev: "/en/india/module/module2"
next: "/en/india/module/module4"
mods:
...
*   IND_Bangalore and IND_BangaloreNorth vector layers (inside module3.gpkg in [module 3 folder](https://drive.google.com/drive/folders/1Tn6b2dtInvYFvnPWuY71uCJh1EAtpjbK?usp=share_link)).
...
![OpenStreetMap website](/open-geodata-curriculum/images/en/india/module3/media/osm.png "OpenStreetMap website")
...
![Colombo layers loaded in QGIS](/open-geodata-curriculum/images/en/india/module3/media/quickosm-1.png "Colombo layers loaded in QGIS")
...
![QuickOSM plugin](/open-geodata-curriculum/images/en/india/module3/media/quickosm-2.png "QuickOSM plugin")
...
![Load all highways in the IND_BangaloreNorth layer extent](/open-geodata-curriculum/images/en/india/module3/media/quickosm-3.png "Load all highways in the IND_BangaloreNorth layer extent")
...
![Highway data loaded from OSM](/open-geodata-curriculum/images/en/india/module3/media/quickosm-4.png "Highway data loaded from OSM")
...
![The Overpass query version of the Quick query to load highways](/open-geodata-curriculum/images/en/india/module3/media/quickosm-5.png "The Overpass query version of the Quick query to load highways")
...
![Load amenities (points) tagged as fast_food in the IND_Bangalore layer extent](/open-geodata-curriculum/images/en/india/module3/media/quickosm-6.png "Load amenities (points) tagged as fast_food in the IND_Bangalore layer extent")
...
![Fast food locations loaded from OSM](/open-geodata-curriculum/images/en/india/module3/media/quickosm-7.png "Fast food locations loaded from OSM")
...
![HRSL data on HDX](/open-geodata-curriculum/images/en/india/module3/media/hdx.png "HRSL data on HDX")
...
![The HRSL for Colombo, Sri Lanka](/open-geodata-curriculum/images/en/india/module3/media/hrsl-1.png "The HRSL for Colombo, Sri Lanka")
...
![QuickOSM parameters for loading fast foods in Bangalore](/open-geodata-curriculum/images/en/india/module3/media/quickosm-6.png "QuickOSM parameters for loading fast foods in Bangalore")

Quick query to load all amenities tagged as fast food

2. Click Show query.

![Overpass version of the query](/open-geodata-curriculum/images/en/india/module3/media/overpass-1.png "Overpass version of the query")
...
![Overpass query to load only fast foods named Burger King](/open-geodata-curriculum/images/en/india/module3/media/overpass-2.png "Overpass query to load only fast foods named Burger King")
...
![Amenities tagged as fast food whose name is Burger King loaded from OSM](/open-geodata-curriculum/images/en/india/module3/media/overpass-3.png "Amenities tagged as fast food whose name is Burger King loaded from OSM")
