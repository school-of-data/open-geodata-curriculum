...
title: ethiopia
language: english
description: Module 6 - Layer Attributes (Ethiopia, English)
date: ""
author: Ben Hur, Ketty
prev: "/en/ethiopia/module/module5"
next: "/en/ethiopia/module/module7"
mods:
...
*   Internet connection
*   QGIS 3.16 and above
*   [Module 6 data](https://drive.google.com/drive/folders/1LUb53DqKTOBx0ek9GKyzAcQ2kGSt3g-3?usp=sharing)
     *   Addis Ababa administrative boundary layer (inside [module6.gpkg](https://drive.google.com/drive/folders/1YQ4jDGNR51Q-vIGsPEE9qDdOng-C0iQM?usp=sharing))
     *   Addis Ababa clinics (inside [module6.gpkg](https://drive.google.com/drive/folders/1YQ4jDGNR51Q-vIGsPEE9qDdOng-C0iQM?usp=sharing))
     *   ETH zones (inside [module6.gpkg](https://drive.google.com/drive/folders/1YQ4jDGNR51Q-vIGsPEE9qDdOng-C0iQM?usp=sharing))
     *   [Addis Ababa High Resolution Settlement Layer](https://drive.google.com/drive/folders/1YQ4jDGNR51Q-vIGsPEE9qDdOng-C0iQM?usp=sharing)
...
![Several polygons](/images/en/ethiopia/module6/media/many-polygons.png "Several polygons")

Figure 6.1: Several polygons


2. The next step is to explore the attribute table interface. Open the attribute table by **Right-clicking on the layer on the Layers Panel ‣ Open Attribute Table**. You can also click the **Open Attribute Table button** ![Open attribute table button](/images/en/ethiopia/module6/media/open-attribute-btn.png "Open attribute table button") from the Attributes Toolbar. This is what the attribute table looks like. The tool bar has a range of buttons, hover over each button to see the embedded functionality.

![Open attribute table](/images/en/ethiopia/module6/media/attribute-tab.png "Open attribute table")

Figure 6.2: Open attribute table

If you don't want the attribute table to be a floating window but rather dock it on the QGIS interface, you can click the **Dock attribute table button** !["Dock attribute table"](/images/en/ethiopia/module6/media/dock-attr-btn.png "Dock attribute table"). When docked, attribute tables will appear as tabs instead of individual windows.

![Docked attribute table](/images/en/ethiopia/module6/media/docked-attribute-tab.png "Docked attribute table")
...
![Planimetric](/images/en/ethiopia/module6/media/gen-settings.png "Planimetric")

Figure 6.4: General settings

5. Next, Click the **Open field calculator** ![alt_text](/images/en/ethiopia/module6/media/field_calculator.png "image_tooltip") button on the Attributes Toolbar to open the field calculator. The field calculator dialogue will open; fill in the output field name, in this case it will be ‘AREA (SQ KM)’. Choose the Decimal number (double) on the output field type. Change the precision to 2 decimal places. To calculate the area, use the following expression:
...
![Field calculator dialogue](/images/en/ethiopia/module6/media/fieldcalc.png "Field calculator dialogue")
...
![New attribute table with new field and attributes](/images/en/ethiopia/module6/media/area.png "New attribute table with new field and attributes")
...
![Add different layers](/images/en/ethiopia/module6/media/add-layers.png "Add different layers")

Figure 6.7: Add different layers

2. The selection will be applied to the Clinics layer, therefore Open the attribute table for the Clinic layer. Click the select features using expression ![alt_text](/images/en/ethiopia/module6/media/select_features_button.png "image_tooltip") button and type the following expression in the expression builder;
...
![alt_text](/images/en/ethiopia/module6/media/select.png "image_tooltip")
...
![alt_text](/images/en/ethiopia/module6/media/selected-canvas.png "image_tooltip")

Figure 6.9: Selected clinic/feature is highlighted (yellow)


![alt_text](/images/en/ethiopia/module6/media/selected-attr.png "image_tooltip")
