...
title: ethiopia
language: english
description: Module 3 - Introduction to OpenStreetMap and the High Resolution Settlement Layer (Ethiopia, English)
date: ""
author: Ben Hur
prev: "/en/ethiopia/module/module2"
next: "/en/ethiopia/module/module4"
mods:
...
*   [Module 3 data](https://drive.google.com/drive/folders/1LUb53DqKTOBx0ek9GKyzAcQ2kGSt3g-3?usp=sharing)
    *   ETH_Addis_Ababa and ETH_Bole vector layers (inside [module3.gpkg](https://drive.google.com/drive/folders/1FV9CIbcOcVp72QKABTVDEUF7O6xkWgD8?usp=sharing)).
    *   HRSL_Addis_Ababa_Population.tif
...
![OpenStreetMap website](/open-geodata-curriculum/images/en/ethiopia/module3/media/osm.png "OpenStreetMap website")
...
![Addis Ababa layers loaded in QGIS](/open-geodata-curriculum/images/en/ethiopia/module3/media/quickosm-1.png "Addis Ababa layers loaded in QGIS")
...
![QuickOSM plugin](/open-geodata-curriculum/images/en/ethiopia/module3/media/quickosm-2.png "QuickOSM plugin")
...
![Load all highways in the ETH_Bole layer extent](/open-geodata-curriculum/images/en/ethiopia/module3/media/quickosm-3.png "Load all highways in the ETH_Bole layer extent")
...
![Highway data loaded from OSM](/open-geodata-curriculum/images/en/ethiopia/module3/media/quickosm-4.png "Highway data loaded from OSM")
...
![The Overpass query version of the Quick query to load highways](/open-geodata-curriculum/images/en/ethiopia/module3/media/quickosm-5.png "The Overpass query version of the Quick query to load highways")
...
![Load amenities (points) tagged as fast_food in the ETH_Addis_Ababa layer extent](/open-geodata-curriculum/images/en/ethiopia/module3/media/quickosm-6.png "Load amenities (points) tagged as fast_food in the ETH_Addis_Ababa layer extent")
...
![Fast food locations loaded from OSM](/open-geodata-curriculum/images/en/ethiopia/module3/media/quickosm-7.png "Fast food locations loaded from OSM")
...
![HRSL data on HDX](/open-geodata-curriculum/images/en/ethiopia/module3/media/hdx.png "HRSL data on HDX")
...
![The HRSL for Addis Ababa, Sri Lanka](/open-geodata-curriculum/images/en/ethiopia/module3/media/hrsl-1.png "The HRSL for Addis Ababa, Sri Lanka")
...
![QuickOSM parameters for loading fast foods in Addis Ababa](/open-geodata-curriculum/images/en/ethiopia/module3/media/quickosm-6.png "QuickOSM parameters for loading fast foods in Addis Ababa")

Quick query to load all amenities tagged as fast food

2. Click Show query.

![Overpass version of the query](/open-geodata-curriculum/images/en/ethiopia/module3/media/quickosm-6.png "Overpass version of the query")
...
![Overpass query to load only fast foods with Burger in their name](/open-geodata-curriculum/images/en/ethiopia/module3/media/overpass-2.png "Overpass query to load only fast foods with Burger in their name")
...
![Amenities tagged as fast food whose name has Burger loaded from OSM](/open-geodata-curriculum/images/en/ethiopia/module3/media/overpass-3.png "Amenities tagged as fast food whose name has Burger loaded from OSM")
