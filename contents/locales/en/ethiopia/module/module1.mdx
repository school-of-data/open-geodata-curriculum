...
![Map of Bogota, Columbia in the style of Starry Starry Night](/images/en/ethiopia/module1/media/sample-1.jpg "Map of Bogota, Columbia in the style of Starry Starry Night")
...
![Storm trace data between 1851 to 2020](/images/en/ethiopia/module1/media/sample-2.jpg "Storm trace data between 1851 to 2020")


This next one ([https://flic.kr/p/FA9TiR](https://flic.kr/p/FA9TiR)) is a map of Kerguelen Island by Heinrich Lingnau Schneider.

![Map of Kerguelen Island](/images/en/ethiopia/module1/media/sample-3.jpg "Map of Kerguelen Island")
...
![Field goal attempts and points scored in UAAP Season 81](/images/en/ethiopia/module1/media/sample-4.jpg "Field goal attempts and points scored in UAAP Season 81")
...
![QGIS Map Showcase](/images/en/ethiopia/module1/media/qgis-map-showcase.png "QGIS Map Showcase")
...
![The QGIS interface](/images/en/ethiopia/module1/media/qgis-interface.png "The QGIS interface")
...
![Parts of the QGIS Interface](/images/en/ethiopia/module1/media/qgis-interface-parts.png "Parts of the QGIS Interface")
...
![QGIS interface with some customizations](/images/en/ethiopia/module1/media/qgis-interface-custom.png "QGIS interface with some customizations")
...
![Open QGIS and click on View menu](/images/en/ethiopia/module1/media/ex01-01.png "Open QGIS and click on View menu")

3. Observe the **Panels** menu

![Observe the Panels menu](/images/en/ethiopia/module1/media/ex01-02.png "Observe the Panels menu")

4. Observe the **Toolbars** menu

![Observe the Toolbars menu](/images/en/ethiopia/module1/media/ex01-03.png "Observe the Toolbars menu")
...
![Manage and Install Plugins menu](/images/en/ethiopia/module1/media/plugins-menu.png "Manage and Install Plugins menu")
...
![Manage and Install Plugins dialog](/images/en/ethiopia/module1/media/manage-and-install-plugins-dialog.png "Manage and Install Plugins dialog")
...
![Open Manage and Install Plugins dialog](/images/en/ethiopia/module1/media/plugins-menu-2.png "Open Manage and Install Plugins dialog")
...
![Install Memory Layer Saver plugin](/images/en/ethiopia/module1/media/memory-layer-saver-plugin.png "Install Memory Layer Saver plugin")

   - QuickOSM

![Install QuickOSM plugin](/images/en/ethiopia/module1/media/quickosm-plugin.png "Install QuickOSM plugin")
...
![The System Settings](/images/en/ethiopia/module1/media/settings-1.png "The System Settings")

Figure 1.7. The System Settings


![Project Settings](/images/en/ethiopia/module1/media/settings-2.png "Project Settings")
...
![General Settings of QGIS](/images/en/ethiopia/module1/media/change-theme.png "General Settings of QGIS")
...
![Accessing User Profiles](/images/en/ethiopia/module1/media/user-profiles-1.png "Accessing User Profiles")
...
![alt_text](/images/en/ethiopia/module1/media/user-profiles-2.png "image_tooltip")


2. Give your new user profile a name.

![alt_text](/images/en/ethiopia/module1/media/user-profiles-3.png "image_tooltip")
