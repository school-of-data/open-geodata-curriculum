...
title: ethiopia
language: english
description: Module 4 - Layer Styling and Symbology (Ethiopia, English)
date: ""
author: Ben Hur
prev: "/en/ethiopia/module/module3"
next: "/en/ethiopia/module/module5"
mods:
...
*   Internet connection
*   QGIS 3.16 or later
*   [Module 4 data](https://drive.google.com/drive/folders/1LUb53DqKTOBx0ek9GKyzAcQ2kGSt3g-3?usp=sharing)
   *   Addis Ababa administrative boundary layer (inside [module4.gpkg](https://drive.google.com/drive/folders/1pcudnNwpLn70IOamUoWx_vOEu6ixCC9f?usp=sharing))
   *   Addis Ababa clinics (inside [module4.gpkg](https://drive.google.com/drive/folders/1pcudnNwpLn70IOamUoWx_vOEu6ixCC9f?usp=sharing))
   *   [Addis Ababa High Resolution Settlement Layer](https://drive.google.com/drive/folders/1pcudnNwpLn70IOamUoWx_vOEu6ixCC9f?usp=sharing)
...
![alt_text](/open-geodata-curriculum/images/en/ethiopia/module4/media/layer-styling.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/en/ethiopia/module4/media/style-vector.png "image_tooltip")

![alt_text](/open-geodata-curriculum/images/en/ethiopia/module4/media/style-raster.png "image_tooltip")
...
2. Add the two vector layers into qgis; Click the Add vector layer button ![alt_text](/open-geodata-curriculum/images/en/ethiopia/module4/media/add-vector.png "image_tooltip") or use the browser panel. 
...
![Default render](/open-geodata-curriculum/images/en/ethiopia/module4/media/default-vector-render.png "Default render")
...
![No fill rendering for the polygon](/open-geodata-curriculum/images/en/ethiopia/module4/media/no-fill-render.png "No fill rendering for the polygon")
...
![Layer Properties dialogue](/open-geodata-curriculum/images/en/ethiopia/module4/media/vector-style.png "Layer Properties dialogue")

Figure 4.5: Layer Properties dialogue

10. The resulting map should look as below

![Final vector render](/open-geodata-curriculum/images/en/ethiopia/module4/media/final-vector-render.png "Final vector render")
...
![Symbology menu](/open-geodata-curriculum/images/en/ethiopia/module4/media/qgis9.png  "Symbology menu")
...
![Population density of Addis Ababa city, Ethiopia](/open-geodata-curriculum/images/en/ethiopia/module4/media/hrsl-style.png "Population density of Addis Ababa city, Ethiopia")

Figure 4.8: Population density of Addis Ababa city, Ethiopia

5.  Zoom in to see the new map in finer detail.

![Zoomed-in map](/open-geodata-curriculum/images/en/ethiopia/module4/media/zoom-in.png "Zoomed-in map")
...
![The expected initial workspace](/open-geodata-curriculum/images/en/ethiopia/module4/media/initial-workspace.png "The expected initial workspace")
...
At the bottom of the Symbology menu, there’s a checkbox for Draw effects. Let’s enable that, and then click the customise effects button ![alt_text](/open-geodata-curriculum/images/en/ethiopia/module4/media/customise-effects-button.png "image_tooltip") to its right:

![Layer Properties window and Symbology menu](/open-geodata-curriculum/images/en/ethiopia/module4/media/draw-effects.png "Layer Properties window and Symbology menu")

Figure 4.11: Layer Properties window and Symbology menu

3. A new Effects Properties dialog opens

![Effects properties dialogue](/open-geodata-curriculum/images/en/ethiopia/module4/media/new-effects-dialog.png "Effects properties dialogue")
...
![Select effect type as blur](/open-geodata-curriculum/images/en/ethiopia/module4/media/blur-effect.png "Select effect type as blur")
...
![Blurry layer](/open-geodata-curriculum/images/en/ethiopia/module4/media/blurry-result.png "Blurry layer")
...
![Effects properties dialogue](/open-geodata-curriculum/images/en/ethiopia/module4/media/drop-shadow.png "Effects properties dialogue")
...
![Drop shadow effect](/open-geodata-curriculum/images/en/ethiopia/module4/media/drop-shadow-result.png "Drop shadow effect")
...
![Centroid operation on administrative boundary layer](/open-geodata-curriculum/images/en/ethiopia/module4/media/centroid.png "Centroid operation on administrative boundary layer")
...
![Point layer](/open-geodata-curriculum/images/en/ethiopia/module4/media/centroid-result.png "Point layer")

Figure 4.18: Point layer

4. Note that an alternative and easier way of writing spatial queries is using the ‘Expressions dialogue’. Click the ![alt_text](/open-geodata-curriculum/images/en/ethiopia/module4/media/expression.png "image_tooltip") expressions  button to open the 'Expression string builder' dialogue box. Here you’ll have access to an extensive function reference. You can search for a function by name. For example, type centroid in the search bar.
