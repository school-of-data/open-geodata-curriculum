...
title: kenya
language: english
description: Module 6 - Layer Attributes (Kenya, English)
date: ""
author: Ben Hur, Ketty
prev: "/en/kenya/module/module5"
next: "/en/kenya/module/module7"
mods:
...
*   Internet connection
*   QGIS 3.16 and above
*   [Module 6 data](https://drive.google.com/drive/folders/1DXRGtW_LBGrO6QspSSzilLzVhg3MVu6x?usp=sharing)
...
![Several polygons](/open-geodata-curriculum/images/en/kenya/module6/media/many-polygons.png "Several polygons")

Figure 6.1: Several polygons


2. The next step is to explore the attribute table interface. Open the attribute table by **Right-clicking on the layer on the Layers Panel ‣ Open Attribute Table**. You can also click the **Open Attribute Table button** ![Open attribute table button](/open-geodata-curriculum/images/en/kenya/module6/media/open-attribute-btn.png "Open attribute table button") from the Attributes Toolbar. This is what the attribute table looks like. The tool bar has a range of buttons, hover over each button to see the embedded functionality.

![Open attribute table](/open-geodata-curriculum/images/en/kenya/module6/media/attribute-tab.png "Open attribute table")

Figure 6.2: Open attribute table

If you don't want the attribute table to be a floating window but rather dock it on the QGIS interface, you can click the **Dock attribute table button** !["Dock attribute table"](/open-geodata-curriculum/images/en/kenya/module6/media/dock-attr-btn.png "Dock attribute table"). When docked, attribute tables will appear as tabs instead of individual windows.

![Docked attribute table](/open-geodata-curriculum/images/en/kenya/module6/media/docked-attribute-tab.png "Docked attribute table")
...
![Field calculator dialogue](/open-geodata-curriculum/images/en/kenya/module6/media/fieldcalc.png "Field calculator dialogue")
...
![New attribute table with new field and attributes](/open-geodata-curriculum/images/en/kenya/module6/media/area.png "New attribute table with new field and attributes")
...
![alt_text](/open-geodata-curriculum/images/en/kenya/module6/media/select.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/en/kenya/module6/media/selected-canvas.png "image_tooltip")

Figure 6.9: Selected clinic/feature is highlighted (yellow)


![alt_text](/open-geodata-curriculum/images/en/kenya/module6/media/selected-attr.png "image_tooltip")
...
* Expression tab ([https://docs.qgis.org/latest/en/docs/pyqgis_developer_cookbook/expressions.html?highlight=vector%20expressions](https://docs.qgis.org/latest/en/docs/user_manual/working_with_vector/expression.html)) which, thanks to a list of predefined functions, helps to write and check the expression to use;
* Function Editor tab ([https://docs.qgis.org/latest/en/docs/user_manual/working_with_vector/expression.html](https://docs.qgis.org/latest/en/docs/user_manual/working_with_vector/expression.html)) which helps to extend the list of functions by creating custom ones.
