...
title: kenya
language: english
description: Module 3 - Introduction to OpenStreetMap and the High Resolution Settlement Layer (Kenya, English)
date: ""
author: Ben Hur
prev: "/en/kenya/module/module2"
next: "/en/kenya/module/module4"
mods:
...
![OpenStreetMap website](/open-geodata-curriculum/images/en/kenya/module3/media/osm.png "OpenStreetMap website")
...
![Kiambu layers loaded in QGIS](/open-geodata-curriculum/images/en/kenya/module3/media/quickosm-1.png "Kiambu layers loaded in QGIS")
...
![QuickOSM plugin](/open-geodata-curriculum/images/en/kenya/module3/media/quickosm-2.png "QuickOSM plugin")
...
![Load all highways in the kiambu_juja_subcounty layer extent](/open-geodata-curriculum/images/en/kenya/module3/media/quickosm-3.png "Load all highways in the kiambu layer extent")
...
![Highway data loaded from OSM](/open-geodata-curriculum/images/en/kenya/module3/media/quickosm-4.png "Highway data loaded from OSM")
...
![The Overpass query version of the Quick query to load highways](/open-geodata-curriculum/images/en/kenya/module3/media/quickosm-5.png "The Overpass query version of the Quick query to load highways")
...
![Load amenities (points) tagged as fast_food in the kiambu_admin_boundary layer extent](/open-geodata-curriculum/images/en/kenya/module3/media/quickosm-6.png "Load amenities (points) tagged as fast_food in the kiambu_admin_boundary layer extent")
...
![Fast food locations loaded from OSM](/open-geodata-curriculum/images/en/kenya/module3/media/quickosm-7.png "Fast food locations loaded from OSM")
...
![HRSL data on HDX](/open-geodata-curriculum/images/en/kenya/module3/media/hdx.png "HRSL data on HDX")
...
![The HRSL for Kiambu County, Kenya](/open-geodata-curriculum/images/en/kenya/module3/media/hrsl-1.png "The HRSL for Kiambu County, Kenya")
...
![QuickOSM parameters for loading fast foods in Kiambu County](/open-geodata-curriculum/images/en/kenya/module3/media/quickosm-5.png "QuickOSM parameters for loading fast foods in Kiambu County")

Quick query to load all amenities tagged as fast food

2. Click Show query.

![Overpass version of the query](/open-geodata-curriculum/images/en/kenya/module3/media/overpass-1.png "Overpass version of the query")
...
![Overpass query to load only fast foods named KFC](/open-geodata-curriculum/images/en/kenya/module3/media/overpass-2.png "Overpass query to load only fast foods named KFC")
...
![Amenities tagged as fast food whose name is  loaded from OSM](/open-geodata-curriculum/images/en/kenya/module3/media/overpass-3.png "Amenities tagged as fast food whose name is KFC loaded from OSM")
