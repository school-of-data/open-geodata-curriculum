...
title: kenya
language: english
description: Module 0 - Gentle Introduction to GIS concepts (Kenya, English)
date: ""
author: Ben Hur
prev: "/en/kenya"
next: "/en/kenya/module/module1"
mods:
...
![True Size Of](/open-geodata-curriculum/images/en/kenya/module0/media/true-size-of.png "True Size of Countries")
...
<table>
  <tr>
   <td>
        <img src="/open-geodata-curriculum/images/en/kenya/module0/media/blue-marble.jpg" />
   ...
   <td>
        <img src="/open-geodata-curriculum/images/en/kenya/module0/media/globe.jpg" />  
...
![The earth as an orange](/open-geodata-curriculum/images/en/kenya/module0/media/dalandan.png "The earth as an orange")
...
![Conformal map projection](/open-geodata-curriculum/images/en/kenya/module0/media/conformal.png "Conformal map projection")
...
![Equal-area map projection](/open-geodata-curriculum/images/en/kenya/module0/media/authalic.png "Equal-area map projection")
...
![Equidistant map projection](/open-geodata-curriculum/images/en/kenya/module0/media/equidistant.png "Equidistant map projection")
...
![Azimuthal equidistant map projection](/open-geodata-curriculum/images/en/kenya/module0/media/az-equidistant.png "Azimuthal equidistant map projection")
...
![Cylinder as a developable surface](/open-geodata-curriculum/images/en/kenya/module0/media/cylinder.png "Cylinder as a developable surface")
...
![Cone as a developable surface](/open-geodata-curriculum/images/en/kenya/module0/media/cone.png "Cone as a developable surface")

Figure 0.8. Conic projections have straight meridians going to one point at the poles. The parallels are arcs.


![Plane as a developable surface](/open-geodata-curriculum/images/en/kenya/module0/media/plane.png "Plane as a developable surface")
...
![Aspects of a map projection](/open-geodata-curriculum/images/en/kenya/module0/media/aspects.png "Aspects of a map projection")
...
![Spatial data model](/open-geodata-curriculum/images/en/kenya/module0/media/spatial-model.png "Spatial data modelling reality")
...
![Raster data model](/open-geodata-curriculum/images/en/kenya/module0/media/raster.png "Raster data model")
...
![Vector data model](/open-geodata-curriculum/images/en/kenya/module0/media/vector.png "Vector data model")
...
![Free and Open Source Software for Geospatial (FOSS4G) applications stack](/open-geodata-curriculum/images/en/kenya/module0/media/foss4g-stack.jpeg "Free and Open Source Software for Geospatial (FOSS4G) applications stack")
