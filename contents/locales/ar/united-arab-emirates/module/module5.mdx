...
language: arabic
description: Module 5 - Map Design and Creation (United Arab Emirates, Arabic)
date: ""
author: Ketty, Ben Hur
prev: "/ar/united-arab-emirates/module/module4"
next: "/ar/united-arab-emirates/module/module6"
mods:
...
*   تخطيط خريطة QGIS 
    *   [https://docs.qgis.org/LATEST/en/docs/training_manual/map_layout/map_layout.html](https://docs.qgis.org/LATEST/en/docs/training_manual/map_layout/map_layout.html)
*   نماذج التصاميم 
    *   [https://layout-hub.github.io/](https://layout-hub.github.io/)
*   مدير النّمط 
    * [https://docs.qgis.org/LATEST/en/docs/user_manual/style_library/style_manager.html](https://docs.qgis.org/LATEST/en/docs/user_manual/style_library/style_manager.html)
*   مكتبة النّمط 
    * [https://docs.qgis.org/LATEST/en/docs/user_manual/style_library/index.html](https://docs.qgis.org/LATEST/en/docs/user_manual/style_library/index.html)
...
![Print layout](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/print_comp2.png "Print layout")
...
![Exporting the map canvas as image](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/export-map-canvas-image.png "Exportzing the map canvas as image")

![Exporting the map](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/export-map-canvas.png "Exporting the map")
...
![Map canvas exported as image](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/exported-map-canvas.png "Map canvas exported as image")
...
![Creating new Print Layout](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/new-print-layout.png "Creating new Print Layout")

Figure 5.4: إنشاء تخطيط طباعة جديد

2. يمكن الآن تصدير لوحة الخريطة إلى تخطيط الطباعة. انقر على "زر تخطيط طباعة جديد" ![New Print Layout](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/newprint_composer.png "New Print Layout") new print layout layout button. يمكن الوصول إلى هذا عبر شريط الأدوات . يمكنك الوصول أيضاً باستخدام شريط قائمة "المشاريع" (Projects menu bar). سيفتح حوار عنوان يطالبك بكتابة عنوان تخطيط الطباعة. اكتب "Dubai" وانقر فوق موافق.


![Naming the Print Layout](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/new-print-layout-name.png "Naming the Print Layout")
...
![The Print Layout window](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/new-print-layout-window.png "The Print Layout window")

Figure 5.6: نافذة تخطيط الطباعة

4. ستلاحظ أن لوحة تخطيط الطباعة فارغة. لإضافة خريطة مصممة من لوحة QGIS، انقر على زر "إضافة خريطة جديدة إلى التخطيط" ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/add_new_map_to_layout.png "image_tooltip") ، وانقر بزر الماوس الأيسر على الماوس وارسم مستطيلًا في المساحة البيضاء في وسط تخطيط الطباعة. يجب أن يتم إضافة الخريطة. لقد قمت للتو بتصدير الخريطة إلى تخطيط الطباعة. أصبح من الممكن الآن إضافة جميع عناصر الخريطة الأخرى مثل العنوان، والمفتاح، الشبكات ، إلخ.


![Add map to Print Layout](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/print-layout-map.png "Add map to Print Layout")
...
1. انقر فوق الزر ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/add_title.png "image_tooltip") "إضافة تسمية" (Add label)، واضغط باستمرار على زر الماوس الأيسر وارسم مستطيلاً حيث تريد وضع عنوان الخريطة. اكتب العنوان ضمن قائمة "الخصائص الرئيسية" (Main properties) على الجانب الأيمن من تخطيط الطباعة. يمكن تغيير خصائص الخط ضمن عنصر القائمة "المظهر" (Appearance).


![Add title of the map](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/print-layout-with-title.png "Add title of the map")
...
![Scale bar](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/scale-bar.png "Scale bar")

Figure 5.9a: أضف شريط مقياس إلى الخريطة

![Legend](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/legend.png "Legend")

Figure 5.9b: أضف مفتاح خريطة إلى الخريطة

![Attribution](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/attribution.png "Attribution")
...
4. احفظ الخريطة كصورة عبر التخطيط ‣ تصدير كصورة … (Layout ‣ Export as Image) أو بالنقر فوق الزر تصدير كصورة ![Export map to image](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/export-image-btn.png "Export map to image") (Export as Image) . سيسألك QGIS عن الملف الذي تريد حفظ الخريطة به بالإضافة إلى معاييرالصورة.

![Image parameters](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/img-parameters.png "Image parameters")

Figure 5.10: خيارات حفظ الخريطة كصورة

![Exported map as imgage](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/exported-map.png "Exported map as imgage")
...
![Coverage layer](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/atlas-coverage.png "Coverage layer")

Figure 5.12: Coverage layer

![Attribute table](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/atlas-attr.png "Attribute table")
...
![Atlas Print Layout](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/atlas-print-layout.png "Atlas Print Layout")

Figure 5.14: تخطيط طباعة أطلس

3. في الجزء الأيمن من تخطيط الطباعة، تأكد من تحديد قائمة أطلس Atlas وتحديد مربع إنشاء أطلس Generate an atlas. يمكنك أيضًا فتح إعدادات أطلس باستخدام زر إعدادات أطلس  ![Atlas Settings](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/atlas-settings-btn.png "Atlas Settings")  على شريط أدوات أطلس Atlas toolbar.

![Atlas Generation](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/generate-atlas.png "Atlas Generation")
...
![Select Coverage Layer](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/coverage-layer.png "Select Coverage Layer")
...
![Controlled by Atlas](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/atlas-controlled.png "Controlled by Atlas")

Figure 5.17: تأكد من أن نطاق الخريطة يتحكم فيه الأطلس

6. لمعاينة Atlas الخاص بك، انقر فوق الزر Preview Atlas  ![Preview Atlas button](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/atlas-preview-btn.png "Preview Atlas button") على شريط أدوات Atlas. سيُظهر لك هذا الـ7 خريطة التي قمت بإنشائها. استخدم شريط أدوات Atlas ![Atlas toolbar](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/atlas-toolbar-nav.png "Atlas toolbar") للتنقل في خرائط Atlas.

![Atlas Preview](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/atlas-preview.png "Atlas Preview")

معاينة أطلس -  Figure 5.18: Atlas Preview

7. يمكنك تصدير خرائط أطلس عبر زر تصدير أطلس (Export Atlas) ![Export Atlas button](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/atlas-export-btn.png "Export Atlas button") إما كصور أو ملفات PDF. حدد تصدير أطلس كصورة (Export Atlas as Image). يجب أن يكون لديك 7 خريطة تم إنشاؤها بحيث تُظهر كل خريطة مدى المقاطعة.

![Atlas Outputs](/open-geodata-curriculum/images/ar/united-arab-emirates/module5/media/atlas-outputs.png "Atlas Outputs")
