...
language: arabic
description: Module 4 - Layer Styling and Symbology (United Arab Emirates, Arabic)
date: ""
author: Ketty, Ben Hur
prev: "/ar/united-arab-emirates/module/module3"
next: "/ar/united-arab-emirates/module/module5"
mods:
...
*    حاسوب
*   اتصال بالإنترنت
*   Qما لا يقل عن QGIS 3.16 مثبتًا على([https://qgis.org/en/site/forusers/download.html](https://qgis.org/en/site/forusers/download.html))
...
*   رموز QGIS -  https://docs.qgis.org/latest/en/docs/training_manual/basic_map/symbology.html
...
![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/layer-styling.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/style-vector.png "image_tooltip")

![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/style-raster.png "image_tooltip")
...
*   Hillshade (([https://docs.qgis.org/latest/en/docs/user_manual/working_with_raster/raster_properties.html#hillshade-renderer](https://docs.qgis.org/latest/en/docs/user_manual/working_with_raster/raster_properties.html#hillshade-renderer)) - يُنشئ ظل تلال من نطاقٍ ما.
...
2. أضف الطبقتين المتجهتين إلى QGIS؛ انقر فوق الزر "إضافة طبقة متجه" (Add vector layer)  ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/add-vector.png "image_tooltip") أو استخدم لوحة المتصفّح.
...
![Default render](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/default-vector-render.png "Default render")
...
![No fill rendering for the polygon](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/no-fill-render.png "No fill rendering for the polygon")
...
![Layer Properties dialogue](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/vector-style.png "Layer Properties dialogue")

Figure 5: حوار خصائص الطبقة

10. يجب أن تبدو الخريطة الناتجة على النحو التالي

![Final vector render](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/final-vector-render.png "Final vector render")
...
![Symbology menu](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/qgis9.png  "Symbology menu")
...
![Population density](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/hrsl-style.png "Population density")

الكثافة السكانية في مقاطعة Dubai_Boundary :Figure 8

5. قم بتكبير الصورة لرؤية الخريطة الجديدة بتفاصيل أدق.

![Zoomed-in map](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/zoom-in.png "Zoomed-in map")
...
![The expected initial workspace](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/initial-workspace.png "The expected initial workspace")

مساحة العمل الأولية المتوقعة: Figure 10

2. افتح نافذة Layer Properties ، ثم انقر فوق عنصر قائمة Symbology لطبقة الحدود الإدارية.    نصيحة: قم بذلك عن طريق النقر المزدوج فوق الطبقة أو استخدام لوحة تصميم الطبقة. قم بتمكين لوحة تصميم الطبقة بالنقر فوق:   View ‣ Panels ‣ Layer Styling. في الجزء السفلي من قائمة الترميز، يوجد مربع اختيار لتأثيرات الرسم. دعنا نقوم بتمكين ذلك، ثم انقر على زر تخصيص التأثيرات  ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/customise-effects-button.png "image_tooltip")  إلى اليمين:

![Layer Properties window and Symbology menu](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/draw-effects.png "Layer Properties window and Symbology menu")

Figure 11: Layer Properties ونافذة  Symbology قائمة

3. سيفتح مربع حوار خصائص التأثيرات الجديد

![Effects properties dialogue](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/new-effects-dialog.png "Effects properties dialogue")
...
![Select effect type as blur](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/blur-effect.png "Select effect type as blur")

حدد نوع التأثير على أنه تمويه: Figure 12

5. قم بتطبيق الإعدادات الآن، سترى أن طبقة المضلع أصبحت الآن ضبابية.

![Blurry layer](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/blurry-result.png "Blurry layer")
...
![Effects properties dialogue](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/drop-shadow.png "Effects properties dialogue")

Figure 15: حوار خصائص التأثيرات

7. يتم رسم التأثيرات من أعلى لأسفل، لذا سيظهر الظل المسقط أسفل مضلعات المصدر

![Drop shadow effect](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/drop-shadow-result.png "Drop shadow effect")
...
![Centroid operation on administrative boundary layer](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/centroid.png "Centroid operation on administrative boundary layer")
...
![Point layer](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/centroid-result.png "Point layer")

Figure 18: طبقة النقطة

4. لاحظ أن الطريقة البديلة والأسهل لكتابة الاستعلامات المكانية هي استخدام "حوار التعبيرات" (Expressions dialogue). انقر فوق الزر ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module4/media/expression.png "image_tooltip") expressions لفتح مربع الحوار "Expression string Builder". هنا سيكون لديك حق الوصول إلى مرجع وظيفي شامل. يمكنك البحث عن وظيفة بالاسم. على سبيل المثال، اكتب centroid في شريط البحث.
