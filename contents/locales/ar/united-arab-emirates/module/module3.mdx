...
language: arabic
description: Module 3 - Introduction to OpenStreetMap and the High Resolution Settlement Layer (United Arab Emirates, Arabic)
date: ""
author: Ben Hur
prev: "/ar/united-arab-emirates/module/module2"
next: "/ar/united-arab-emirates/module/module4"
mods:
...
*    حاسوب
*   اتصال بالإنترنت
*   ما لا يقل عن QGIS 3.16 مثبتًا على([https://qgis.org/en/site/forusers/download.html](https://qgis.org/en/site/forusers/download.html))
...
![OpenStreetMap website](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/osm.png "OpenStreetMap website")
...
![Colombo layers loaded in QGIS](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/quickosm-1.png "Colombo layers loaded in QGIS")
...
![QuickOSM plugin](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/quickosm-2.png "QuickOSM plugin")
...
![Load all highways in the admin_boundary layer extent](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/quickosm-3.png "Load all highways in the admin_boundary layer extent")
...
![Highway data loaded from OSM](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/quickosm-4.png "Highway data loaded from OSM")
...
![The Overpass query version of the Quick query to load highways](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/quickosm-5.png "The Overpass query version of the Quick query to load highways")
...
![Load amenities (points) tagged as fast_food in the Colombo_admin_boundary layer extent](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/quickosm-6.png "Load amenities (points) tagged as fast_food in the Colombo_admin_boundary layer extent")
...
![Fast food locations loaded from OSM](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/quickosm-7.png "Fast food locations loaded from OSM")
...
![HRSL data on HDX](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/hdx.png "HRSL data on HDX")
...
![The HRSL](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/hrsl-1.png "The HRSL")
...
![QuickOSM parameters for loading fast foods](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/quickosm-6.png "QuickOSM parameters for loading fast foods")
...
![Overpass version of the query](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/overpass-1.png "Overpass version of the query")
...
![Overpass query to load only fast foods named KFC](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/overpass-2.png "Overpass query to load only fast foods named KFC")
...
![Amenities tagged as fast food whose name is KFC loaded from OSM](/open-geodata-curriculum/images/ar/united-arab-emirates/module3/media/overpass-3.png "Amenities tagged as fast food whose name is KFC loaded from OSM")
