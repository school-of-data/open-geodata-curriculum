...
language: arabic
description: Module 2 - Layers in QGIS (United Arab Emirates, Arabic)
date: ""
author: Ben Hur
...
*    حاسوب
*   اتصال بالإنترنت
*   ما لا يقل عن QGIS 3.16 مثبتًا على الكمبيوتر([https://qgis.org/en/site/forusers/download.html](https://qgis.org/en/site/forusers/download.html))
...
![Multiple layer analysis in GIS](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/spatial-layers.jpg "Multiple layer analysis in GIS")
...
[https://docs.qgis.org/LATEST/en/docs/user_manual/introduction/browser.html](https://docs.qgis.org/LATEST/en/docs/user_manual/introduction/browser.html)
...
![The QGIS Browser Panel](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/qgis-browser-1.png "The QGIS Browser Panel")
...
5. افحص الملفات الموجودة داخل المجلد (Figure 3). هناك العديد منها. من شجرة الملف نفسها، يمكننا بالفعل الحصول على فكرة عن الملفات والطبقات التي يمكننا تحميلها في QGIS. تشير الرموز الموجودة على يسار الأسماء إلى ما إذا كانت البيانات متجهًا ![Vector symbol](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/symbol-vector.png "Vector symbol") أم نقطية ![Raster symbol](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/symbol-raster.png "Raster symbol") أم قاعدة بيانات
![Database symbol](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/symbol-db.png "Database symbol") أم بيانات جدولية بسيطة ![Table symbol](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/symbol-table.png "Table symbol")

    
![Module 2 files in the Browser Panel](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/qgis-browser-2.png "Module 2 files in the Browser Panel")
...
![Checking Layer Properties](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/qgis-browser-3.png "Checking Layer Properties")

Figure 4.فحص خصائص الطبقة


![Layer Properties from Browser Panel](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/qgis-browser-layer-properties.png "Layer Properties from Browser Panel")
...
![The vector layers loaded in QGIS](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/vector-layers-loaded-1.png "The vector layers loaded in QGIS")
...
![The Layers Panel](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/layers-panel-1.png "The Layers Panel")
...
لمعرفة المزيد حول لوحة الطبقات ، يمكنك الذهاب إلى الرابط التالي:[https://docs.qgis.org/LATEST/en/docs/user_manual/introduction/general_tools.html#layers-panel](https://docs.qgis.org/LATEST/en/docs/user_manual/introduction/general_tools.html#layers-panel)
...
![The Layer Properties dialog](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/layer-properties.png "The Layer Properties dialog")
...
لمعرفة المزيد حول خصائص طبقة المتجهات ، يمكنك الذهاب إلى الرابط التالي: [https://docs.qgis.org/LATEST/en/docs/user_manual/working_with_vector/vector_properties.html](https://docs.qgis.org/LATEST/en/docs/user_manual/working_with_vector/vector_properties.html) 

لمعرفة المزيد حول خصائص الطبقة النقطية ، يمكنك الذهاب إلى الرابط التالي: [https://docs.qgis.org/LATEST/en/docs/user_manual/working_with_raster/raster_properties.html](https://docs.qgis.org/LATEST/en/docs/user_manual/working_with_raster/raster_properties.html)
...
![Information properties of the boundary_administrative_dubai_multipolygons layer](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/metadata-1.png "Information properties of the boundary_administrative_dubai_multipolygons layer")
...
![Editing some metadata](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/metadata-2.png "Editing some metadata")
...
![The Information tab after editing some metadata](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/metadata-3.png "The Information tab after editing some metadata")
...
![Data Source Manager](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/data-source-manager-1.png "Data Source Manager")
...
2. تحميل المتجه
    ...
    2. لنقم بتحميل ملف المتجه الموجود داخل حزمة geopackage boundary_administrative_dubai.
        1. نوع المصدر: ملف
        2. المصدر: حدد حزمة geopackage boundary_administrative_dubai باستخدام الزر ![Search button](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/data-source-manager-search.png "Search button")
        3. انقر فوق إضافة
        4. إذا كان هناك أكثر من ملف متجه واحد داخل حزمة geopackage، سيطلب منك QGIS تحديد الملفات المراد تحميلها


![Loading a vector inside a GeoPackage](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/data-source-manager-vector.png "Loading a vector inside a GeoPackage")
...
3. تحميل البيانات النقطية
    1. لتحميل البيانات النقطية، انتقل إلى علامة التبويب النقطية. يمكن تحميل الملفات والملفات البعيدة عبر بروتوكول مثل HTTP والسحابة وما إلى ذلك. هناك خطوط نقطية (OSM Standard) داخل حزمة geopackage OSM Standard.
        1. نوع المصدر: ملف
        2. المصدر: حدد حزمة geopackage OSM Standard باستخدام الزر ![Search button](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/data-source-manager-search.png "Search button")
        3. انقر فوق إضافة
        4. إذا كان هناك أكثر من ملف نقطي داخل حزمة geopackage، فسوف يطلب منك QGIS تحديد الملفات المراد تحميلها


![Loading a raster inside a GeoPackage](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/data-source-manager-raster.png "Loading a raster inside a GeoPackage")
...
4. تحميل CSV وملفات نصية محددة أخرى
    ...
    4. يوجد ملف CSV في مجلد البيانات باسم amenity_fast_food_dubai.csv والذي يحتوي على مواقع نقاط المدارس في القاهرة. لتحميله:
        ...
        2. اسم الملف: حدد amenity_fast_food_dubai CSV باستخدام الزر  ![Search button](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/data-source-manager-search.png "Search button")
        3. صيغة الملف: CSV
...
![Loading a CSV file](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/data-source-manager-csv.png "Loading a CSV file")
...
![Layers Panel with all layers loaded](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/layers-panel-2.png "Layers Panel with all layers loaded")
...
![QGIS Interface with all layers loaded](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/map-canvas-1.png "QGIS Interface with all layers loaded")
...
![Adding an XYZ connection in QGIS](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/xyz-1.png "Adding an XYZ connection in QGIS")
...
![Adding ESRI World Imagery as XYZ Tiles](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/xyz-2.png "Adding ESRI World Imagery as XYZ Tiles")
...
![ESRI World Imagery layer loaded in QGIS](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/xyz-3.png "ESRI World Imagery layer loaded in QGIS")
...
![Creating a new WMS/WMTS Connection](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/wms-1.png "Creating a new WMS/WMTS Connection")
...
![The FAO Geonode WMS added in the Browser Panel](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/wms-2.png "The FAO Geonode WMS added in the Browser Panel")
...
![FAO Geonode layer map from WMS loaded in QGIS](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/wms-3.png "FAO Geonode layer map from WMS loaded in QGIS")
...
![Exporting a layer from QGIS](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/exporting-layers.png "Exporting a layer from QGIS")
...
![Save Vector Layer dialog](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/save-vector.png "Save Vector Layer dialog")
...
هذا ما يفهمه QGIS  لذلك فهو يسمح للمستخدمين بإنشاء طبقات مؤقتة. يمكن استخدام هذه الطبقات بشكل مشابه لطبقات المتجه العادية ولكن لا يلزم حفظها بشكل دائم في ملف في محركات أقراص التخزين لدينا لأن QGIS يخزنها في الذاكرة أو الـ RAM. تظهر الطبقات المؤقتة في لوحة الطبقات مع هذه الأيقونة  ![Temporary layer symbol](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/symbol-temp.png "Temporary layer symbol").
...
بالطبع يمكنك أيضًا جعل الطبقة المؤقتة دائمة عن طريق تصدير الطبقة إلى ملف. سيؤدي النقر فوق الرمز ![Temporary layer symbol](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/symbol-temp.png "Temporary layer symbol") إلى فتح مربع حوار طبقة التصدير تلقائيًا.
...
![Connect to GeoNode](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/connect-geonode.png "Connect to GeoNode")
...
3. قم بإنشاء طبقة geopackage جديدة باستخدام ![Create new geopakage symbol](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/symbol-gpkg.png "Create new geopakage symbol") في شريط أدوات مدير مصدر البيانات. قم بتسميتها Trees، أضف حقول نصف قطر (عدد صحيح) وأنواع (نص) ، واستخدم CRS مُسقط (مثل EPSG: 3857)


![New GeoPackage Layer](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/virtual-1.png "New GeoPackage Layer")

إذا طُلبَ منك أن الملف موجود بالفعل، حدد إضافة طبقة جديدة.


![GeoPackage Layer exists](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/virtual-2.png "GeoPackage Layer exists")

4. قم بتبديل التعديل على Trees بالنقر بزر الماوس الأيمن فوقه -> تبديل التعديل  right-clicking on it -> Toggle editing  أو النقر على ![Toggle editing symbol](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/symbol-edit.png "Toggle editing symbol")  في شريط أدوات التحويل الرقمي Digitizing Toolbar.
5. حدد منطقة على صورة القمر الصناعي بحيث تتضمّن الأشجار.
6. مع تشغيل التعديل، قم بتمكين إضافة نقاط إلى طبقة الأشجار بالنقر فوق ![Add new point symbol](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/symbol-add-point.png "[Add new point symbol") (CTRL + .).
...
![Add new trees](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/virtual-3.png "Add new trees")

8. بعد إضافة النقاط، لا تنس حفظ تعديلاتك عن طريق نقر ![Save edits symbol](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/symbol-save-edits.png "Save edits symbol") على شريط أدوات التحويل الرقمي قبل إيقاف تشغيل التعديل.


![New points (trees) added](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/virtual-4.png "New points (trees) added]")

9. أضف طبقة افتراضية بالنقر فوق ![Add virtual layer symbol](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/symbol-virtual.png "Add virtual layer symbol") في شريط أدوات مدير مصدر البيانات.
...
![Create Virtual Layer](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/virtual-5.png "Create Virtual Layer")

![Virtual layer in QGIS](/open-geodata-curriculum/images/ar/united-arab-emirates/module2/media/virtual-6.png "Virtual layer in QGIS")
