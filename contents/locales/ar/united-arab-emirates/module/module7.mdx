...
language: arabic
description: Module 7 - Creating and Editing Layers (United Arab Emirates, Arabic)
date: ""
author: Ketty, Ben Hur
prev: "/ar/united-arab-emirates/module/module6"
next: ""
mods:
...
*   إنشاء الطبقات - [https://docs.qgis.org/latest/en/docs/user_manual/managing_data_source/create_layers.html](https://docs.qgis.org/latest/en/docs/user_manual/managing_data_source/create_layers.html)
*   رقمنة مواقف الغابات - [https://docs.qgis.org/latest/en/docs/training_manual/forestry/stands_digitazing.html?highlight=digitizing](https://docs.qgis.org/latest/en/docs/training_manual/forestry/stands_digitazing.html?highlight=digitizing)
*   اقرأ أيضًا: تحديد الإسناد الجغرافي للخريطة [https://docs.qgis.org/latest/en/docs/training_manual/forestry/map_georeferencing.html?highlight=georeferencing](https://docs.qgis.org/latest/en/docs/training_manual/forestry/map_georeferencing.html?highlight=georeferencing)
...
![Remotely sensed images of different coastlines](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//rs-images.png "Remotely sensed images of different coastlines")
...
![Here, buildings have been digitized (traced) on top of an aerial photo](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//buildings.png "Here, buildings have been digitized (traced) on top of an aerial photo")
...
1. لإنشاء طبقة GeoPackage جديدة، اضغط على زر New GeoPackage Layer ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//geopackage-button.png "image_tooltip") في قائمة طبقة ‣ إنشاء طبقة (Layer ‣ Create Layer) أو من شريط أدوات إدارة مصدر البيانات (Datasource Manager). سيتم عرض مربع حوار New GeoPackage Layer كما هو موضح في Figure 7.3.

![New GeoPackage Layer dialogue](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//new-geopackage-dialog.png "New GeoPackage Layer dialogue")

Figure 7.3: حوار جديد حول طبقة GeoPackage

2. الخطوة الأولى هي الإشارة إلى موقع ملف قاعدة البيانات. يمكن القيام بذلك عن طريق الضغط على زر ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//database-file-location.png "image_tooltip") على جانب حقل قاعدة البيانات وتحديد ملف GeoPackage الحالي أو إنشاء ملف جديد. سيضيف QGIS تلقائيًا الامتداد الصحيح للاسم الذي تقدمه.
...
5. حدد النظام المرجعي للإحداثيات باستخدام الزر ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//mActionSetProjection.png "image_tooltip")
...
6. لإضافة حقول إلى الطبقة التي تقوم بإنشائها:
    ...
    4. انقر فوق الزر "إضافة إلى قائمة الحقول" ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//mActionNewAttribute.png "image_tooltip") (Add to Fields List)
...
1. لإنشاء طبقة صيغة Shapefile ESRI جديدة، اضغط على الزر  ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//mActionNewVectorLayer.png "image_tooltip") New Shapefile Layer… في طبقة ‣ إنشاء طبقة ‣ قائمة (Layer ‣ Create Layer ‣ menu) أو من شريط أدوات إدارة قاعدة البيانات (Data (Source Manager. سيتم عرض مربع حوار New Shapefile Layer كما هو موضح في Figure 7.4.

![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//new-shapefile-dialog.png "image_tooltip")
...
6. حدد النظام المرجعي للإحداثيات باستخدام الزر  ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//mActionSetProjection.png "image_tooltip")، يمكنك تحديد WGS 84 العالمي المناسب تمامًا لمشاريع رسم خرائط الويب لجميع أنحاء العالم.
7. لإضافة الحقول إلى الطبقة التي تقوم بإنشائها:
    ...
    4. انقر فوق الزر "إضافة إلى قائمة الحقول" ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//mActionNewAttribute.png "image_tooltip") 
...
2. أنشئ مشروعًا جديدًا في QGIS من خلال النقر على أيقونة مشروع جديد  ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//new-project.png  "image_tooltip").
3. انتقل إلى Layer ‣ Create Layer ‣ New GeoPackage Layer . سيظهر لك مربع الحوار التالي:

![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//new-vector.png "image_tooltip")
...
![ESRI World Imagery found in Browser Panel](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//xyz-2.png "ESRI World Imagery found in Browser Panel")

![ESRI World Imagery loaded in QGIS](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//xyz-3.png "ESRI World Imagery loaded in QGIS")
...
![ESRI World Imagery layer zoomed in](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//digitize-zoom.png "ESRI World Imagery layer zoomed in")

Figure 7.7: مكبّرة ESRI World طبقة صورة  

6. دعنا ندخل وضع التحرير لطبقة المباني
7. حدد المباني في لوحة Layers
8. انقر فوق الزر "تبديل التحرير" _Toggle Editing_ ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//edit-layer.png "image_tooltip")
...
![Digitizing tools](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//digi-toolbar.png "Digitizing tools")
...
11. انقر فوق الزر "إضافة ميزة" ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//add-feature.png "image_tooltip") لبدء الرقمنة. سنقوم برقمنة المباني
...
![ Digitizing new feature](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//digitize-1.png "Digitizing new feature")

Figure 7.8.1:رقمنة ميزة جديدة

![Fill in the attribute values](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//digitize-2.png "Fill in the attribute values")

Figure 7.8.2: إضافة السمات

16. انقر فوق موافق. لقد أنشأت ميزة جديدة!

![New feature created](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//digitize-3.png "New feature created")
...
![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//select-feature.png "image_tooltip")
...
<table>
  <tr>
   <td>
<img src="/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media/image186.png" width="" alt="alt_text" title="image_tooltip" />
   </td>
   <td>
...
نقل الميزة (الميزات) بأكملها
  ...
  <tr>
   <td>
<img src="/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media/image187.png" width="" alt="alt_text" title="image_tooltip" />
   </td>
   <td>
أدوات العقدة
...
نقل نقطة واحدة فقط حيث قد تكون أخطأت
  ...
  <tr>
   <td>
<img src="/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media/image188.png" width="" alt="alt_text" title="image_tooltip" />
...
2. انقر فوق الزر إضافة نقطية  ![Add Raster](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//EAU_topo_map.png "Add Raster") لإضافة ملف صورة الخريطة Topo Map of UAE - 1984 كصورة للإسناد الجغرافي. ستتم إضافة الخريطة الطبوغرافية إلى لوحة المرجعية الجغرافية. يمكنك الآن التكبير لقراءة تفاصيل الخريطة. تتمثل إحدى طرق القيام بذلك في قراءة البيانات الوصفية ومعلومات ومفتاح الخريطة في الجزء السفلي ثم ربطها بالميزات الموجودة على الخريطة.

![Map in Georeferencer canvas](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//georeferencer.png "Map in Georeferencer canvas")

Figure 7.9: الخريطة على لوحة المرجعية الجغرافية

بعد ذلك، يجب عليك تحديد إعدادات التحويل للمرجعية الجغرافية للخريطة:

3. افتح الإعدادات ‣ إعدادات التحويل أو انقر فوق الزر إعدادات التحويل ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//georef-settings-btn.png "image_tooltip").
4. انقر فوق أيقونة  ![alt_text](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//dots.png "image_tooltip") بجوار مربع Output raster، وانتقل إلى المجلد وأنشئ المجلد "data" وقم بتسمية الملف باسم /Topo Map of Egypt- 1799_georef.tif.
5. اضبط باقي الميزات كما هو موضّح أدناه

![Transformation parameters](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//transformation-settings.png "Transformation parameters")
...
9. اذهب الآن إلى لوحة (Georeferencer) انقر فوق الزر  ![Add Point](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//add-point.png "Add Point") Add Point وانقر فوق تقاطع الخطوط المتقاطعة (قم بالتحريك والتكبير حسب الحاجة).
10. اكتب الإحداثيات التي حصلت عليها من خريطة (ESRI WORLD IMAGERY) في مربع حوار إدخال إحداثيات الخريطة.

![Select GCP](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//georef-1.png "Select GCP")

![Enter map coordinates](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//georef-2.png "Enter map coordinates")
...
![First coordinate for the georeferencing](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//georef-3.png "First coordinate for the georeferencing")
...
16. أخيرًا، قم بإنشاء مرجع جغرافي لخريطتك باستخدام ملف ‣ بدء الإسناد الجغرافي (File ► Start georeferencing) أو زر تشغيل المرجعية الجغرافية  ![Start Georeferencing button](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//georef-start-btn.png "Start Georeferencing button").

![GCPs added](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//georef-4.png "GCPs added")

Figure 7.13: GCPs إضافة الـ

![Georeferenced map loaded in QGIS](/open-geodata-curriculum/images/ar/united-arab-emirates/module7/media//georef-5.png "Georeferenced map loaded in QGIS")
