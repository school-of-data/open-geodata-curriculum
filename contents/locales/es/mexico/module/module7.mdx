...
prev: "/es/mexico/module/module6"
next: "/es/mexico/module/module8"
mods:
...
*   [Datos en la carpeta module7](https://drive.google.com/drive/folders/1ZTpu7SR3aVF21TiSJt19C_Itdo5xHC_b?usp=sharing)
...
*   Creación de capas - [https://docs.qgis.org/latest/es/docs /user_manual/managing_data_source/create_layers.htmlrodales](https://docs.qgis.org/latest/es/docs/user_manual/managing_data_source/create_layers.html)
*   Digitalización de forestales - [https://docs.qgis.org/latest/es/docs/training_manual/forestry/stands_digitazing.html?highlight=digitizing](https://docs.qgis.org/latest/es/docs/training_manual/forestry/stands_digitazing.html?highlight=digitizing)
*   Lectura adicional: [Georreferenciación de un mapa](https://docs.qgis.org/latest/es/docs/training_manual/forestry/map_georeferencing.html?highlight=georeferencing)
...
![Remotely sensed images of different coastlines](/open-geodata-curriculum/images/es/mexico/module7/media/rs-images.png "Remotely sensed images of different coastlines")
...
![Here, buildings have been digitized (traced) on top of an aerial photo](/open-geodata-curriculum/images/es/mexico/module7/media/buildings.png "Here, buildings have been digitized (traced) on top of an aerial photo")
...
1. Para crear una nueva capa GeoPackage, presione el botón Nueva capa GeoPackage ![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/geopackage-button.png "image_tooltip") en el menú Capa ‣ Crear capa o en la barra de herramientas del Administrador de fuentes de datos. El cuadro de diálogo Nueva capa de GeoPackage se mostrará como se muestra en la Figura 7.3.

![New GeoPackage Layer dialogue](/open-geodata-curriculum/images/es/mexico/module7/media/new-geopackage-dialog.png "New GeoPackage Layer dialogue")

Figura 7.3: Cuadro de diálogo Nueva capa de GeoPackage

2. El primer paso es indicar la ubicación del archivo de la base de datos. Esto se puede hacer presionando el  botón ![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/database-file-location.png "image_tooltip") a la derecha del campo Base de datos y seleccionar un archivo GeoPackage existente o crear uno nuevo. QGIS agrega automáticamente la extensión correcta al nombre que proporcione.
...
5. Especifique el sistema de referencia de coordenadas usando el botón![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/mActionSetProjection.png "image_tooltip")
...
6. Para agregar campos a la capa que está creando:
    ...
    4. Haga clic en el botón ![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/mActionNewAttribute.png "image_tooltip") Agregar a la lista de campos. 
...
1. Para crear una nueva capa de formato ESRI Shapefile, presione el botón ![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/mActionNewVectorLayer.png "image_tooltip") New Shapefile Layer ... en el menú Capa ‣ Crear capa ‣ o desde el Barra de herramientas del Administrador de fuentes de datos. El cuadro de diálogo Nueva capa de Shapefile se mostrará como se muestra en la Figura 7.4.

![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/new-shapefile-dialog.png "image_tooltip")
...
6. Especifique el sistema de referencia de coordenadas usando el botón![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/mActionSetProjection.png "image_tooltip"), puede seleccionar el WGS84 universal que es adecuado para proyectos de mapeo web en todo el mundo.
...
7. Para agregar campos a la capa que está creando:
    ...
    4. Haga clic en el botón Agregar a la lista de campos ![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/mActionNewAttribute.png "image_tooltip"). 
...
2. Cree un nuevo proyecto en QGIS haciendo clic en el ícono _Proyecto Nuevo_![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/new-project.png  "image_tooltip").
3. Vaya a _Capa ‣ Crear capa ‣ Nueva capa de GeoPackage_. Se le presentará el siguiente diálogo:

![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/new-vector.png "image_tooltip")
...
![ESRI World Imagery found in Browser Panel](/open-geodata-curriculum/images/es/mexico/module7/media/xyz-2.png "ESRI World Imagery found in Browser Panel")

![ESRI World Imagery loaded in QGIS](/open-geodata-curriculum/images/es/mexico/module7/media/xyz-3.png "ESRI World Imagery loaded in QGIS")
...
![ESRI World Imagery layer zoomed in](/open-geodata-curriculum/images/es/mexico/module7/media/digitize-zoom.png "ESRI World Imagery layer zoomed in")
...
8. Pulse en el _botón Editar_ ![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/edit-layer.png "image_tooltip")
...
![Digitizing tools](/open-geodata-curriculum/images/es/mexico/module7/media/digi-toolbar.png "Digitizing tools")
...
11. Haga clic en _Agregar función_ ![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/add-feature.png "image_tooltip") para comenzar a digitalizar. Digitalizaremos los edificios.
...
![ Digitizing new feature](/open-geodata-curriculum/images/es/mexico/module7/media/digitize-1.png "Digitizing new feature")

Figura 7.8.1: Digitalización de una nueva característica

![Fill in the attribute values](/open-geodata-curriculum/images/es/mexico/module7/media/digitize-2.png "Fill in the attribute values")

Figura 7.8.2: Agregando los atributos

16. Haga clic en _Aceptar_. ¡Has creado una nueva función!

![New feature created](/open-geodata-curriculum/images/es/mexico/module7/media/digitize-3.png "New feature created")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/select-feature.png "image_tooltip")
...
<table>
  <tr>
   <td>
<img src="/images/es/mexico/module7/media/image186.png" width="" alt="alt_text" title="image_tooltip" />
...
<img src="/images/es/mexico/module7/media/image187.png" width="" alt="alt_text" title="image_tooltip" />
...
<img src="/images/es/mexico/module7/media/image188.png" width="" alt="alt_text" title="image_tooltip" />
...
2. Haga clic en el botón Agregar ráster ![Add Raster](/open-geodata-curriculum/images/es/mexico/module7/media/add-raster.png "Add Raster") para agregar el archivo de imagen del mapa topográfico cartas_250k__3160-III.jpg, como imagen a georreferenciar. El mapa topográfico se agregará al lienzo del georreferenciador. Ahora puede acercar la imagen para leer los detalles del mapa. Una forma de hacerlo es leyendo los metadatos y la información de la leyenda en la parte inferior y luego relacionándolos con las características en el mapa.

![Map in Georeferencer canvas](/open-geodata-curriculum/images/es/mexico/module7/media/georeferencer.png "Map in Georeferencer canvas")
...
3. Abra Configuración ► Configuración de transformación o haga clic en el botón Configuración de transformación ![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/georef-settings-btn.png "image_tooltip").
4. Haga clic en el ![alt_text](/open-geodata-curriculum/images/es/mexico/module7/media/dots.png "image_tooltip") icono junto al cuadro Ráster de salida, vaya a la carpeta y cree la carpeta 'datos pampanga' y nombre el archivo como jalisco_georef.tif.
5. Establezca el resto de parámetros como se muestra a continuación

![Transformation parameters](/open-geodata-curriculum/images/es/mexico/module7/media/transformation-settings.png "Transformation parameters")
...
9. Haga clic en el botón Agregar punto ![Add Point](/open-geodata-curriculum/images/es/mexico/module7/media/add-point.png "Add Point") y haga clic en la intersección de la cruz filar (panorámica y zoom según sea necesario).
10. En el diálogo Ingresar coordenadas del mapa, escriba las coordenadas que aparecen en el mapa (Y: 14 ° 45 '00' 'y X: 120 ° 30' 00 '').

![Select GCP](/open-geodata-curriculum/images/es/mexico/module7/media/georef-1.png "Select GCP")

Figura 7.11.1: Ingrese las coordenadas del mapa

![Enter map coordinates](/open-geodata-curriculum/images/es/mexico/module7/media/georef-2.png "Enter map coordinates")
...
![First coordinate for the georeferencing](/open-geodata-curriculum/images/es/mexico/module7/media/georef-3.png "First coordinate for the georeferencing")
...
16. Finalmente, georreferenciar su mapa con **Archivo ► Iniciar georreferenciación** o el botón Iniciar georreferenciación ![Start Georeferencing button](/open-geodata-curriculum/images/es/mexico/module7/media/georef-start-btn.png "Start Georeferencing button").

![GCPs added](/open-geodata-curriculum/images/es/mexico/module7/media/georef-4.png "GCPs added")

Figura 7.13: GCP agregados

![Georeferenced map loaded in QGIS](/open-geodata-curriculum/images/es/mexico/module7/media/georef-5.png "Georeferenced map loaded in QGIS")
