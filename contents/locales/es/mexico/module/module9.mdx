...
*   [Datos en la carpeta module9](https://drive.google.com/drive/folders/1ZTpu7SR3aVF21TiSJt19C_Itdo5xHC_b?usp=sharing)
    *   module9.gpkg
...
![A matrix of values](/open-geodata-curriculum/images/es/mexico/module9/media/fig91.png "A matrix of values")
...
![On the left side, the values are assigned to centroids. On the right, values are assigned to the grid cell area - the pixel.](/open-geodata-curriculum/images/es/mexico/module9/media/fig92.png "On the left side, the values are assigned to centroids. On the right, values are assigned to the grid cell area - the pixel.")
...
![Electromagnetic spectrum (photo credit [NASA Science](https://science.nasa.gov/ems/01_intro))](/open-geodata-curriculum/images/es/mexico/module9/media/fig94.png "Electromagnetic spectrum (photo credit [NASA Science](https://science.nasa.gov/ems/01_intro))")
...
![Example of a histogram, where x is a raster layer](/open-geodata-curriculum/images/es/mexico/module9/media/fig95.png "Example of a histogram, where x is a raster layer")
...
![Loaded raster datasets](/open-geodata-curriculum/images/es/mexico/module9/media/fig96.png "Loaded raster datasets")
...
![Extracting basic metadata from a raster layer](/open-geodata-curriculum/images/es/mexico/module9/media/fig97.png "Extracting basic metadata from a raster layer")
...
![Reproject functionality in QGIS](/open-geodata-curriculum/images/es/mexico/module9/media/fig98.png "Reproject functionality in QGIS")
...
![Warp (reproject) QGIS window](/open-geodata-curriculum/images/es/mexico/module9/media/fig99_a.png "Warp (reproject) QGIS window")
...
![Reprojected HRSL](/open-geodata-curriculum/images/es/mexico/module9/media/fig99_b.png "Reprojected HRSL")
...
![Resample method - nearest neighbour](/open-geodata-curriculum/images/es/mexico/module9/media/fig910.png "Resample method - nearest neighbour")
...
![Resample method - bilinear](/open-geodata-curriculum/images/es/mexico/module9/media/fig911.png "Resample method - bilinear")
...
![Batch processing tab on a QGIS functionality window](/open-geodata-curriculum/images/es/mexico/module9/media/fig912.png "Batch processing tab on a QGIS functionality window")
...
![Batch processing to reproject the land cover rasters](/open-geodata-curriculum/images/es/mexico/module9/media/fig913_a.png "Batch processing to reproject the land cover rasters")

Figura 9.13a - Procesamiento por lotes para reproyectar los rásteres de cobertura terrestre

![Autofill output names](/open-geodata-curriculum/images/es/mexico/module9/media/fig913_b.png "Autofill output names")

Figure 9.13b - Autofill output names

![Reprojected land cover rasters](/open-geodata-curriculum/images/es/mexico/module9/media/fig913_c.png "Reprojected land cover rasters")
...
![Finding the GDAL merge tool in the Processing Toolbox](/open-geodata-curriculum/images/es/mexico/module9/media/fig914.png "Finding the GDAL merge tool in the Processing Toolbox")
...
![Selecting the ASTER layers to merge](/open-geodata-curriculum/images/es/mexico/module9/media/fig915_a.png "Selecting the ASTER layers to merge")

Figure 9.15a - Selecting the ASTER layers to merge

![Parameters of the Merge processing algorithm](/open-geodata-curriculum/images/es/mexico/module9/media/fig915_b.png "Parameters of the Merge processing algorithm")

Figure 9.15b - Parameters of the Merge processing algorithm

![Mosaic of all DSM files corresponding to our work region](/open-geodata-curriculum/images/es/mexico/module9/media/fig915_c.png "Mosaic of all DSM files corresponding to our work region")
...
![Reproject Merged raster](/open-geodata-curriculum/images/es/mexico/module9/media/fig915_d.png "Reproject Merged raster")
...
![Batch process to extract information in a separate HTML file for multiple raster layers](/open-geodata-curriculum/images/es/mexico/module9/media/fig916.png "Batch process to extract information in a separate HTML file for multiple raster layers")
...
![Histogram window](/open-geodata-curriculum/images/es/mexico/module9/media/fig917.png "Histogram window")
...
![Zooming in on the DSM_mosaic_5235 computed histogram](/open-geodata-curriculum/images/es/mexico/module9/media/fig918.png "Zooming in on the DSM_mosaic_5235 computed histogram")
...
![Selecting min and max values to reclassify the raster](/open-geodata-curriculum/images/es/mexico/module9/media/fig919.png "Selecting min and max values to reclassify the raster")
...
![The Value Tool Panel](/open-geodata-curriculum/images/es/mexico/module9/media/fig920.png "The Value Tool Panel")
...
![Loaded value tool - highlight on first tab - Table](/open-geodata-curriculum/images/es/mexico/module9/media/fig921.png "Loaded value tool - highlight on first tab - Table")
...
![Using a vector mask to extract the raster data on a specific region](/open-geodata-curriculum/images/es/mexico/module9/media/fig922.png "Using a vector mask to extract the raster data on a specific region")
...
![Batch process cliping all required raster layers by Jalisco geometry](/open-geodata-curriculum/images/es/mexico/module9/media/fig923.png "Batch process cliping all required raster layers by Jalisco geometry")
...
![Raster layers clipped by Jalisco contour](/open-geodata-curriculum/images/es/mexico/module9/media/fig924.png "Raster layers clipped by Jalisco contour")
...
![DSM_mosaic_clipped representation](/open-geodata-curriculum/images/es/mexico/module9/media/fig925.png "DSM_mosaic_clipped representation")
...
![Opening the Raster calculator](/open-geodata-curriculum/images/es/mexico/module9/media/fig926_a.png "Opening the Raster calculator")

Figure 9.26a - Opening the Raster calculator

![Raster calculator](/open-geodata-curriculum/images/es/mexico/module9/media/fig926_b.png "Raster calculator")
...
![Inserting a formula into the Raster Calculator](/open-geodata-curriculum/images/es/mexico/module9/media/fig927.png "Inserting a formula into the Raster Calculator")

Figura 9.27 - Insertar una fórmula en la Calculadora ráster.

Su resultado debería verse como en la figura 9.28.

![Result of identify all pixel values that are below 200 meters using the Raster Calculator](/open-geodata-curriculum/images/es/mexico/module9/media/fig928.png "Result of identify all pixel values that are below 200 meters using the Raster Calculator")
...
![Spatial distribution of all pixels of value 1, meaning with altitude lower than 200 meters](/open-geodata-curriculum/images/es/mexico/module9/media/fig929.png "Spatial distribution of all pixels of value 1, meaning with altitude lower than 200 meters")
...
![Using raster calculator to identify population distribution classes based on altitude of up to 200m](/open-geodata-curriculum/images/es/mexico/module9/media/fig930.png "Using raster calculator to identify population distribution classes based on altitude of up to 200m")
...
![Using Value Tool to check results of Raster Calculator](/open-geodata-curriculum/images/es/mexico/module9/media/fig931.png "Using Value Tool to check results of Raster Calculator")
...
![Distribution of population that lives below 50 in Colombo district, represented at a 30m resolution](/open-geodata-curriculum/images/es/mexico/module9/media/fig932.png "Distribution of population that lives below 200m in Colombo district, represented at a 30m resolution")
...
![Raster to vector conversion](/open-geodata-curriculum/images/es/mexico/module9/media/fig933_a.png "Raster to vector conversion")
...
![Raster to vector conversion parameters](/open-geodata-curriculum/images/es/mexico/module9/media/fig933_b.png "Raster to vector conversion parameters")
...
![Result of converting a raster dataset to a vector dataset](/open-geodata-curriculum/images/es/mexico/module9/media/fig934.png "Result of converting a raster dataset to a vector dataset")
...
![Identifying Zonal Statistics in the Processing Toolbox](/open-geodata-curriculum/images/es/mexico/module9/media/fig935.png "Identifying Zonal Statistics in the Processing Toolbox")
...
![Setting the parameters for Zonal Statistics](/open-geodata-curriculum/images/es/mexico/module9/media/fig936.png "Setting the parameters for Zonal Statistics")
...
![Resulting vector layer of Zonal Statistics](/open-geodata-curriculum/images/es/mexico/module9/media/fig937.png "Resulting vector layer of Zonal Statistics")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig938.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig939.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig942.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig943.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig944.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig945.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig946_a.png "image_tooltip")

Figura 9.46a - Producto de remuestreo de cobertura terrestre usando el método de remuestreo del vecino más cercano

![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig946_b.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig947.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig948_a.png "image_tooltip")

![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig948_b.png "image_tooltip")

![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig948_c.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig949.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig950_a.png "image_tooltip")

Figura 9.50a - Poligonización de la capa ráster LC2019_Mode (30m)

![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig950_b.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig951.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig952.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig953_a.png "image_tooltip")

Figura 9.53a - Píxeles ráster a puntos

![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig953_b.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig954.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig955.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig956.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig957.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig958.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig959.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig960.png "image_tooltip")
...
![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig961.png "image_tooltip")

Figura 9.61 - Parámetros del algoritmo Unir atributos por ubicación (resumen)

![alt_text](/open-geodata-curriculum/images/es/mexico/module9/media/fig962.png "image_tooltip")
