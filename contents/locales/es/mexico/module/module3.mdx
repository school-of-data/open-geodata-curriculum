...
title: mexico
language: spanish
description: Módulo 3 - OpenStreetMap y la Capa de Alta Resolución de Asentamientos
date: ""
author: Ben Hur
prev: "/es/mexico/module/module2"
next: "/es/mexico/module/module4"
mods:
...
![OpenStreetMap website](/open-geodata-curriculum/images/es/mexico/module3/media//osm.png "OpenStreetMap website")
...
![Jalisco layers loaded in QGIS](/open-geodata-curriculum/images/es/mexico/module3/media//quickosm-1.png "Jalisco layers loaded in QGIS")
...
![QuickOSM plugin](/open-geodata-curriculum/images/es/mexico/module3/media//quickosm-2.png "QuickOSM plugin")
...
![Load all highways in the limite_estadual_Jalisco layer extent](/open-geodata-curriculum/images/es/mexico/module3/media//quickosm-3.png "Load all highways in the limite_estadual_Jalisco layer extent")
...
![Highway data loaded from OSM](/open-geodata-curriculum/images/es/mexico/module3/media//quickosm-4.png "Highway data loaded from OSM")
...
![The Overpass query version of the Quick query to load highways](/open-geodata-curriculum/images/es/mexico/module3/media//quickosm-5.png "The Overpass query version of the Quick query to load highways")
...
![Load amenities (points) tagged as fast_food in the limite_estadual_Jalisco layer extent](/open-geodata-curriculum/images/es/mexico/module3/media//quickosm-6.png "Load amenities (points) tagged as fast_food in the limite_estadual_Jalisco layer extent")
...
![Fast food locations loaded from OSM](/open-geodata-curriculum/images/es/mexico/module3/media//quickosm-7.png "Fast food locations loaded from OSM")
...
![HRSL data on HDX](/open-geodata-curriculum/images/es/mexico/module3/media//hdx.png "HRSL data on HDX")
...
![The HRSL for Jalisco, Mexico](/open-geodata-curriculum/images/es/mexico/module3/media//hrsl-1.png "The HRSL for Jalisco, Mexico")
...
![QuickOSM parameters for loading fast foods in Pampanga](/open-geodata-curriculum/images/es/mexico/module3/media//quickosm-6.png "QuickOSM parameters for loading fast foods in Pampanga")

Consulta rápida para cargar todos los servicios etiquetados como comida rápida

2. Haz clic en mostrar consulta.

![Overpass version of the query](/open-geodata-curriculum/images/es/mexico/module3/media//overpass-1.png "Overpass version of the query")
...
![Overpass query to load only fast foods named Okuma](/open-geodata-curriculum/images/es/mexico/module3/media//overpass-2.png "Overpass query to load only fast foods named Okuma")
...
![Amenities tagged as fast food whose name is Okuma loaded from OSM](/open-geodata-curriculum/images/es/mexico/module3/media//overpass-3.png "Amenities tagged as fast food whose name is Okuma loaded from OSM")
