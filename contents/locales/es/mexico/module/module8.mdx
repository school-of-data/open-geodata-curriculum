...
title: mexico
language: spanish
description: Módulo 8 - Procesamiento y análisis de vectores
date: ""
author: Codrina
prev: "/es/mexico/module/module7"
next: "/es/mexico/module/module9"
mods:
...
*   [Datos en la carpeta module8](https://drive.google.com/drive/folders/1ZTpu7SR3aVF21TiSJt19C_Itdo5xHC_b?usp=sharing)
    *   pois (point)
    *   pofw (point)
    *   road (line)
    *   waterways (line)
...
*   [https://docs.qgis.org/latest/es/docs/user_manual/working_with_vector/functions_list.html](https://docs.qgis.org/latest/es/docs/user_manual/working_with_vector/functions_list.html)
...
![Getting from point A to B using Openstreetmap](/open-geodata-curriculum/images/es/mexico/module8/media/fig81.png "Getting from point A to B using Openstreetmap")
...
![Vector lines representing streets and the associated attribute table](/open-geodata-curriculum/images/es/mexico/module8/media/fig82.png "Vector lines representing streets and the associated attribute table")
...
![vector data with attribute table](/open-geodata-curriculum/images/es/mexico/module8/media/fig83.png "vector data with attribute table")
...
![elements of a geoprocessing operation](/open-geodata-curriculum/images/es/mexico/module8/media/fig84.png "elements of a geoprocessing operation")
...
![Loaded vector data sets: points, line and polygons](/open-geodata-curriculum/images/es/mexico/module8/media/fig85.png "Loaded vector data sets: points, line and polygons")
...
![Specifications of the coordinate reference system used in the QGIS project](/open-geodata-curriculum/images/es/mexico/module8/media/fig86.png "Specifications of the coordinate reference system used in the QGIS project")
...
![Basics statistics for fields](/open-geodata-curriculum/images/es/mexico/module8/media/fig87.png "Basics statistics for fields")
...
![Preparing to run basics statistics for roads layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig88.png "Preparing to run basics statistics for roads layer")
...
![Topology checker plugin](/open-geodata-curriculum/images/es/mexico/module8/media/fig89_a.png "Topology checker plugin")

Figure 8.9.a - Topology checker plugin

To show the Topology Checker, enable it as a panel under **View ‣ Panels ‣ Topology Checker** (figure 8.9.b). If it does not appear in the Panels menu, you can enable it by clicking the Topology Checker button ![Topology checker button](/open-geodata-curriculum/images/es/mexico/module8/media/fig89_btn.png "Topology checker button") on the Plugins toolbar. Once activated it’s window looks like in figure 8.9.c. 

![Topology checker panel](/open-geodata-curriculum/images/es/mexico/module8/media/fig89_b.png "Topology checker panel")

Figura 8.9.b - Panel de verificación de topología; 

![Topology checker window](/open-geodata-curriculum/images/es/mexico/module8/media/fig89_c.png "Topology checker window")

Figura 8.9.c - Ventana del verificador de topología

To define the topology rules, click on the third icon ![Topology rule settings button](/open-geodata-curriculum/images/es/mexico/module8/media/fig810_btn.png "Topology rule settings button"), opening a window as in figure 8.10. 

![Topology rule settings window](/open-geodata-curriculum/images/es/mexico/module8/media/fig810.png "Topology rule settings window")
...
[Topology rules dropdown menu based on the selected layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig811.png "Topology rules dropdown menu based on the selected layer")
...
![Topology rules to be set](/open-geodata-curriculum/images/es/mexico/module8/media/fig812.png "Topology rules to be set")

Figura 8.12 - Reglas de topología que se establecerán

Click on the first icon ![Validate rules button](/open-geodata-curriculum/images/es/mexico/module8/media/fig813_btn.png "Validate rules button") on the Topology Checker window to run and wait for the results. After running the topology check, your map windows should look like in figure 8.13. 

![Topology check results](/open-geodata-curriculum/images/es/mexico/module8/media/fig813.png "Topology check results")
...
![Duplicate point error in points of interest vector layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig814.png "sDuplicate point error in points of interest vector layer")
...
![ Delete duplicate geometries on layer points of interest](/open-geodata-curriculum/images/es/mexico/module8/media/fig815.png " Delete duplicate geometries on layer points of interest")
...
![Result of running delete duplicate geometries](/open-geodata-curriculum/images/es/mexico/module8/media/fig816.png "Result of running delete duplicate geometries")
...
![Topology check on the buildings vector layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig817_a.png "Topology check on the buildings vector layer")
...
![Results of topology check on the buildings vector layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig817_b.png "Results of topology check on the buildings vector layer")
...
![Remove duplicate geometries on the buildings vector layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig818_a.png "Remove duplicate geometries on the buildings vector layer")

Figure 8.18a - Remove duplicate geometries on the buildings vector layer

![Results of remove duplicate geometries on the buildings vector layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig818_b.png "Results of remove duplicate geometries on the buildings vector layer")

![Results of Delete duplicate geometries](/open-geodata-curriculum/images/es/mexico/module8/media/fig818_c.png "Results of Delete duplicate geometries")
...
![List unique values in a vector layer functionality](/open-geodata-curriculum/images/es/mexico/module8/media/fig819_a.png "List unique values in a vector layer functionality")
...
![List unique values in a vector layer functionality (Batch Processing)](/open-geodata-curriculum/images/es/mexico/module8/media/fig819_b.png "List unique values in a vector layer functionality (Batch Processing)")
...
![GroupStats plugin](/open-geodata-curriculum/images/es/mexico/module8/media/fig820_a.png "GroupStats plugin")

Figure 8.20a - GroupStats plugin

Debería abrirse una nueva ventana como la de la figura 8.20b.

![GroupStats window](/open-geodata-curriculum/images/es/mexico/module8/media/fig820_b.png "GroupStats window")
...
![Running GroupStats on the building layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig821.png "Running GroupStats on the building layer")
...
![Running GroupStats on the roads layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig822.png "Running GroupStats on the roads layer")
...
![Setting the parameters for a 30 m buffer around the places of worship](/open-geodata-curriculum/images/es/mexico/module8/media/fig823.png "Setting the parameters for a 30 m buffer around the places of worship")
...
![Running buffer on a point vector layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig824.png "Running buffer on a point vector layer")
...
![Calculate area for the newly obtained layer, then calculate using GroupStats the total sum](/open-geodata-curriculum/images/es/mexico/module8/media/fig825.png "Running buffer on Calculate area for the newly obtained layer, then calculate using GroupStats the total sum point vector layer")
...
![Figure 8.26a - Select landuse fclass = industrial](/open-geodata-curriculum/images/es/mexico/module8/media/fig826_a.png "Figure 8.26a - Select landuse fclass = industrial")

Figure 8.26a - Select landuse fclass = industrial. 

![Reduced selection of a few buildings and industrial landuse, so the computation can finish faster](/open-geodata-curriculum/images/es/mexico/module8/media/fig826_b.png "Reduced selection of a few buildings and industrial landuse, so the computation can finish faster")
...
![Running the Clip algorithm](/open-geodata-curriculum/images/es/mexico/module8/media/fig827_a.png "Running the Clip algorithm")
...
![Results of the clip functionality](/open-geodata-curriculum/images/es/mexico/module8/media/fig827_b.png "Results of the clip functionality")
...
![Filtering the poi layer to get all schools](/open-geodata-curriculum/images/es/mexico/module8/media/fig828_a.png "Filtering the poi layer to get all schools")

Figure 8.28a - Filtering the poi layer to get all schools

![All schools in the poi layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig828_b.png "All schools in the poi layer")

Figure 8.28b - All schools in the poi layer

![Running the Voronoi polygon algorithm](/open-geodata-curriculum/images/es/mexico/module8/media/fig828_c.png "Running the Voronoi polygon algorithm")

Figure 8.28c - Running the Voronoi polygon algorithm

![Results of applying Thiessen (Voronoi) polygons algorithm to a point vector layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig828_d.png "Results of applying Thiessen (Voronoi) polygons algorithm to a point vector layer")
...
![Creating a 10X10km vector grid for Jalisco](/open-geodata-curriculum/images/es/mexico/module8/media/fig829_a.png "Creating a 10X10km vector grid for Jalisco")
...
![10X10km vector grid for Jalisco](/open-geodata-curriculum/images/es/mexico/module8/media/fig829_b.png "10X10km vector grid for Jalisco")
...
![Filtering green areas and built-up space in Jalisco](/open-geodata-curriculum/images/es/mexico/module8/media/fig830_a.png "Filtering green areas and built-up space in Jalisco ")

Figure 8.30a - Filtering green areas and built-up space in Jalisco 

![Spatial distribution of the green areas and built-up space in Jalisco](/open-geodata-curriculum/images/es/mexico/module8/media/fig830_b.png "Spatial distribution of the green areas and built-up space in Jalisco")
...
![Parameters for the intersect algorithm](/open-geodata-curriculum/images/es/mexico/module8/media/fig831.png "Parameters for the intersect algorithm")
...
![Result of running the intersection algorithm to clip the landuse vector polygons to the grid layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig832.png "Result of running the intersection algorithm to clip the landuse vector polygons to the grid layer")
...
![Landuse features clipped per each grid cell and it's associated attribute table](/open-geodata-curriculum/images/es/mexico/module8/media/fig833.png "Landuse features clipped per each grid cell and it's associated attribute table")
...
![Selecting the green spaces](/open-geodata-curriculum/images/es/mexico/module8/media/fig834_a.png "Selecting the green spaces")

Figure 8.34a - Selecting the green spaces.

![Selected green spaces](/open-geodata-curriculum/images/es/mexico/module8/media/fig834_b.png "Selected green spaces")

Figure 8.34b - Selected green spaces.

![Green and Built-up spaces](/open-geodata-curriculum/images/es/mexico/module8/media/fig834_c.png "Green and Built-up spaces")
...
![Computing the area of each feature](/open-geodata-curriculum/images/es/mexico/module8/media/fig834_d.png "Computing the area of each feature")

Figure 8.34d - Computing the area of each feature.

![GroupStat parameters setup to sum up the green areas per each 10X10km grid cell](/open-geodata-curriculum/images/es/mexico/module8/media/fig834_e.png "GroupStat parameters setup to sum up the green areas per each 10X10km grid cell")
...
![Loading green_spaces_gridded CSV](/open-geodata-curriculum/images/es/mexico/module8/media/fig835_a.png "Loading green_spaces_gridded CSV")

Figure 8.35a - Loading green_spaces_gridded CSV

![The green_spaces_gridded CSV attribute table](/open-geodata-curriculum/images/es/mexico/module8/media/fig835_b.png "The green_spaces_gridded CSV attribute table")
...
![Green and built-up CSV joined to Grid](/open-geodata-curriculum/images/es/mexico/module8/media/fig836_a.png "Green and built-up CSV joined to Grid")

Figure 8.36a - Green and built-up CSV joined to Grid. 

![Attribute table of the grid10km vector layer containing the total areas for green and built-up spaces](/open-geodata-curriculum/images/es/mexico/module8/media/fig836_b.png "Attribute table of the grid10km vector layer containing the total areas for green and built-up spaces")
...
![Percentage of green area in the 10km x 10km grid](/open-geodata-curriculum/images/es/mexico/module8/media/fig837_a.png "Percentage of green area in the 10km x 10km grid")

Figure 8.37a - Percentage of green area in the 10km x 10km grid

![Computed percentage of green and built-up area](/open-geodata-curriculum/images/es/mexico/module8/media/fig837_b.png "Computed percentage of green and built-up area")

Figure 8.37b - Computed percentage of green and built-up area

![Computing for the ratio of green and built-up areas](/open-geodata-curriculum/images/es/mexico/module8/media/fig837_c.png "Computing for the ratio of green and built-up areas")

Figure 8.37c - Computing for the ratio of green and built-up areas

![Computed ratio of green and built-up areas](/open-geodata-curriculum/images/es/mexico/module8/media/fig837_d.png "Computed ratio of green and built-up areas")

Figure 8.37d - Computed ratio of green and built-up areas

![Ratio of green and built-up areas in the 10km x 10km grid](/open-geodata-curriculum/images/es/mexico/module8/media/fig837_e.png "Ratio of green and built-up areas in the 10km x 10km grid")
...
![Sum Line Lengths parameters](/open-geodata-curriculum/images/es/mexico/module8/media/fig838_a.png "Sum Line Lengths parameters")

Figure 8.38a - Sum Line Lengths parameters

![Road lengths and counts per Grid cell](/open-geodata-curriculum/images/es/mexico/module8/media/fig838_b.png "Road lengths and counts per Grid cell")

Figure 8.38b - Road lengths and counts per Grid cell

![Spatial distribution of 10X10km units with most roads](/open-geodata-curriculum/images/es/mexico/module8/media/fig838_c.png "Spatial distribution of 10X10km units with most roads")
...
![Spatial distribution of 10X10km units with most waterways](/open-geodata-curriculum/images/es/mexico/module8/media/fig839.png "Spatial distribution of 10X10km units with most waterway")
...
![Selecting towns and cities POIs](/open-geodata-curriculum/images/es/mexico/module8/media/fig840_a.png "Selecting towns and cities POIs")

Figure 8.40a - Selecting towns and cities POI

![Selected towns and cities POIs](/open-geodata-curriculum/images/es/mexico/module8/media/fig840_b.png "Selected towns and cities POIs")
...
![Count towns and cities POIs in each 10km x 10km grid](/open-geodata-curriculum/images/es/mexico/module8/media/fig840_c.png "Count towns and cities POIs in each 10km x 10km grid")

Figure 8.40c - Count towns and cities POIs in each 10km x 10km grid

![Spatial distribution of towns and cities POIs density per unit 10X10km](/open-geodata-curriculum/images/es/mexico/module8/media/fig840_d.png "Spatial distribution of towns and cities POIs density per unit 10X10km")
...
![Interpolation methods available in QGIS](/open-geodata-curriculum/images/es/mexico/module8/media/fig841.png "Interpolation methods available in QGIS")
...
![Creating random points inside a polygon layer](/open-geodata-curriculum/images/es/mexico/module8/media/fig842.png "Creating random points inside a polygon layer")
...
![Point data layer - randomly created within specified polygons](/open-geodata-curriculum/images/es/mexico/module8/media/fig843.png "Point data layer - randomly created within specified polygons")
...
![Creating random values within specified limits](/open-geodata-curriculum/images/es/mexico/module8/media/fig844.png "Creating random values within specified limits")
...
![Fictitious precipitation data for the 93 fictitious meteo stations in Colombo district](/open-geodata-curriculum/images/es/mexico/module8/media/fig845.png "Fictitious precipitation data for the 93 fictitious meteo stations in Colombo district")
...
![Setting up the batch processing window to interpolate the precipitation values for all 7 days](/open-geodata-curriculum/images/es/mexico/module8/media/fig846.png "Setting up the batch processing window to interpolate the precipitation values for all 7 days")
...
![Interpolated datasets](/open-geodata-curriculum/images/es/mexico/module8/media/fig847.png "Interpolated datasets")
...
![Setting temporal information to the raster dataset (1)](/open-geodata-curriculum/images/es/mexico/module8/media/fig848_a.png "Setting temporal information to the raster dataset (1)")

![Setting temporal information to the raster dataset (2)](/open-geodata-curriculum/images/es/mexico/module8/media/fig848_b.png "Setting temporal information to the raster dataset (2)")

![Setting temporal information to the raster dataset (7)](/open-geodata-curriculum/images/es/mexico/module8/media/fig848_c.png "Setting temporal information to the raster dataset (7)")
...
![Set the parameters of the Time Controller Panel](/open-geodata-curriculum/images/es/mexico/module8/media/fig849.png "Set the parameters of the Time Controller Panel")

Figura 8.49 - Configure los parámetros del Panel de controlador de tiempo.

Haga clic en el botón de reproducción ![Play button](/open-geodata-curriculum/images/es/mexico/module8/media/play-btn.png "Play button") y vea cómo cambian los valores. Puede elegir qué otras capas serán visibles. En la figura 8.50, agregamos la capa vectorial de edificios.

![Selecting other layers to be visible in the temporal animation](/open-geodata-curriculum/images/es/mexico/module8/media/fig850.png "Selecting other layers to be visible in the temporal animation")
