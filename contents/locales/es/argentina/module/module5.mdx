...
date: ""
author: Ben Hur
prev: "/es/argentina/module/module4"
next: "/es/argentina/module/module6"
mods:
...
*   Administrador de estilos - [https://docs.qgis.org/latest/en/docs/user_manual/style_library/style_manager.html](https://docs.qgis.org/latest/en/docs/user_manual/style_library/style_manager.html)
*   Biblioteca de estilos - [https: / /docs.qgis.org/latest/en/docs/user_manual/style_library/index.html](https://docs.qgis.org/latest/en/docs/user_manual/style_library/index.html)
...
![Print layout](/open-geodata-curriculum/images/es/argentina/module5/media/print_comp2.png "Print layout")
...
![Exporting the map canvas as image](/open-geodata-curriculum/images/es/argentina/module5/media/export-map-canvas-image.png "Exportzing the map canvas as image")

![Exporting the map](/open-geodata-curriculum/images/es/argentina/module5/media/export-map-canvas.png "Exporting the map")
...
![Map canvas exported as image](/open-geodata-curriculum/images/es/argentina/module5/media/exported-map-canvas.png "Map canvas exported as image")
...
![Creating new Print Layout](/open-geodata-curriculum/images/es/argentina/module5/media/new-print-layout.png "Creating new Print Layout")

Figura 5.4: Creación de un nuevo diseño de impresión

2. El lienzo del mapa ahora se puede exportar al diseño de impresión. Haga clic en el "botón de nuevo diseño de diseño de impresión" ![New Print Layout](/open-geodata-curriculum/images/es/argentina/module5/media/newprint_composer.png "New Print Layout"). Se puede acceder a esto a través de la barra de herramientas. Alternativamente, acceda usando la barra de menú 'Proyectos'. Se abrirá un cuadro de diálogo de título que le pedirá que escriba el título del Diseño de impresión. Escriba 'Santa Fe' y haga clic en Aceptar.

![Naming the Print Layout](/open-geodata-curriculum/images/es/argentina/module5/media/new-print-layout-name.png "Naming the Print Layout")

Figura 5.5: Nombrar el diseño de impresión 

3. Se abrirá el diseño de impresión.

![The Print Layout window](/open-geodata-curriculum/images/es/argentina/module5/media/new-print-layout-window.png "The Print Layout window")

Figura 5.6: La ventana Diseño de impresión

4. Notará que el lienzo de diseño de impresión está vacío. Para agregar el mapa con estilo del lienzo de QGIS, haga clic en el botón 'Agregar nuevo mapa al diseño' ![alt_text](/open-geodata-curriculum/images/es/argentina/module5/media/add_new_map_to_layout.png "image_tooltip")![alt_text](images/image9.png "image_tooltip"), haga clic con el botón izquierdo del mouse y dibuje un rectángulo en el espacio en blanco en el centro del diseño de impresión. Debe agregarse el mapa. Acaba de exportar un mapa al diseño de impresión. Ahora es posible agregar todos los demás elementos del mapa como el título, la leyenda, las cuadrículas, etc.

![Add map to Print Layout](/open-geodata-curriculum/images/es/argentina/module5/media/print-layout-map.png "Add map to Print Layout")
...
1. Haga clic en el botón 'Agregar etiqueta' ![alt_text](/open-geodata-curriculum/images/es/argentina/module5/media/add_title.png "image_tooltip"), mantenga presionado el botón izquierdo del mouse y dibuje un rectángulo donde le gustaría colocar el título del mapa. Escriba el título en el menú 'Propiedades principales' en el lado derecho del diseño de impresión. Las propiedades de la fuente se pueden cambiar en el elemento de menú "Apariencia".

![Add title of the map](/open-geodata-curriculum/images/es/argentina/module5/media/print-layout-with-title.png "Add title of the map")
...
![Scale bar](/open-geodata-curriculum/images/es/argentina/module5/media/scale-bar.png "Scale bar")

Figura 5.9a: Agregar barra de escala al mapa

![Legend](/open-geodata-curriculum/images/es/argentina/module5/media/legend.png "Legend")

Figura 5.9b: Agregar leyenda al mapa

![Attribution](/open-geodata-curriculum/images/es/argentina/module5/media/attribution.png "Attribution")
...
4. Guarde el mapa como una imagen usando a través de Diseño ‣ Exportar como imagen ... o haciendo clic en el botón Exportar como imagen ![Export map to image](/open-geodata-curriculum/images/es/argentina/module5/media/export-image-btn.png "Export map to image"). QGIS le preguntará en qué archivo guardar el mapa, así como los parámetros de la imagen.

![Image parameters](/open-geodata-curriculum/images/es/argentina/module5/media/img-parameters.png "Image parameters")

Figura 5.10: Agregar atribución al mapa

![Exported map as imgage](/open-geodata-curriculum/images/es/argentina/module5/media/exported-map.png "Exported map as imgage")
...
![Coverage layer](/open-geodata-curriculum/images/es/argentina/module5/media/atlas-coverage.png "Coverage layer")

Figura 5.12: Capa de cobertura

![Attribute table](/open-geodata-curriculum/images/es/argentina/module5/media/atlas-attr.png "Attribute table")
...
![Atlas Print Layout](/open-geodata-curriculum/images/es/argentina/module5/media/atlas-print-layout.png "Atlas Print Layout")

Figura 5.14: Diseño de impresión Atlas


3. En el panel derecho del Diseño de impresión, asegúrese de seleccionar el menú Atlas y marcar la casilla Generar un atlas. También puede abrir la Configuración de Atlas usando el botón Configuración de Atlas ![Atlas Settings](/open-geodata-curriculum/images/es/argentina/module5/media/atlas-settings-btn.png "Atlas Settings") en la barra de herramientas de Atlas.

![Atlas Generation](/open-geodata-curriculum/images/es/argentina/module5/media/generate-atlas.png "Atlas Generation")
...
![Select Coverage Layer](/open-geodata-curriculum/images/es/argentina/module5/media/coverage-layer.png "Select Coverage Layer")
...
![Controlled by Atlas](/open-geodata-curriculum/images/es/argentina/module5/media/atlas-controlled.png "Controlled by Atlas")

Figura 5.17: Asegúrese de que la extensión del mapa esté controlada por el Atla


6. Para obtener una vista previa de su Atlas, haga clic en el botón Vista previa del Atlas ![Preview Atlas button](/open-geodata-curriculum/images/es/argentina/module5/media/atlas-preview-btn.png "Preview Atlas button") en la barra de herramientas Atlas. Esto le mostrará los 81 mapas que generó. Utilice la barra de herramientas de Atlas ![Atlas toolbar](/open-geodata-curriculum/images/es/argentina/module5/media/atlas-toolbar-nav.png "Atlas toolbar") para navegar por los mapas de Atlas.

![Atlas Preview](/open-geodata-curriculum/images/es/argentina/module5/media/atlas-preview.png "Atlas Preview")

Figura 5.18: Vista previa de Atlas

7. Puede exportar los mapas de Atlas mediante el botón Exportar Atlas, ![Export Atlas button](/open-geodata-curriculum/images/es/argentina/module5/media/atlas-export-btn.png "Export Atlas button") ya sea como imágenes o PDF. Seleccione Exportar Atlas como imagen. Debería tener 24 mapas generados donde cada mapa muestra la extensión de la provincia.

![Atlas Outputs](/open-geodata-curriculum/images/es/argentina/module5/media/atlas-outputs.png "Atlas Outputs")
