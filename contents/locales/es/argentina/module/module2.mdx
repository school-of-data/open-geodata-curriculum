...
date: ""
author: Ben Hur
prev: "/es/argentina/module/module1"
next: "/es/argentina/module/module3"
mods:
...
Guía del usuario de QGIS - [https://docs.qgis.org/latest/en/docs/user_manual/](https://docs.qgis.org/latest/en/docs/user_manual/)

Manual de entrenamiento en QGIS - [https://docs.qgis.org/latest/en/docs/training_manual/index.html](https://docs.qgis.org/latest/en/docs/training_manual/index.html)


## Introducción Temática

![Multiple layer analysis in GIS](/open-geodata-curriculum/images/es/argentina/module2/media/spatial-layers.jpg "Multiple layer analysis in GIS")
...
![The QGIS Browser Panel](/open-geodata-curriculum/images/es/argentina/module2/media/qgis-browser-1.png "The QGIS Browser Panel")
...
5. Verifica los archivos dentro de la carpeta (Figura 3). Hay muchos de ellos. Desde el árbol de archivos en sí, ya podemos hacernos una idea de los archivos y capas que podemos cargar en QGIS. Los iconos a la izquierda de los nombres indican si los datos son un vector ![Vector symbol](/open-geodata-curriculum/images/es/argentina/module2/media/symbol-vector.png "Vector symbol"), un ráster ![Raster symbol](/open-geodata-curriculum/images/es/argentina/module2/media/symbol-raster.png "Raster symbol"), una base de datos ![Database symbol](/open-geodata-curriculum/images/es/argentina/module2/media/symbol-db.png "Database symbol"), o datos tabulares simples ![Table symbol](/open-geodata-curriculum/images/es/argentina/module2/media/symbol-table.png "Table symbol"). 


![Module 2 files in the Browser Panel](/open-geodata-curriculum/images/es/argentina/module2/media/qgis-browser-2.png "Module 2 files in the Browser Panel")
...
![Checking Layer Properties](/open-geodata-curriculum/images/es/argentina/module2/media/qgis-browser-3.png "Checking Layer Properties")

Figura 4. Observando Propiedades de la Capa


![Layer Properties from Browser Panel](/open-geodata-curriculum/images/es/argentina/module2/media/qgis-browser-layer-properties.png "Layer Properties from Browser Panel")
...
![The vector layers loaded in QGIS](/open-geodata-curriculum/images/es/argentina/module2/media/vector-layers-loaded-1.png "The vector layers loaded in QGIS")
...
![The Layers Panel](/open-geodata-curriculum/images/es/argentina/module2/media/layers-panel-1.png "The Layers Panel")
...
Para aprender más, visita: [https://docs.qgis.org/latest/en/docs/user_manual/introduction/general_tools.html#capas-panel](https://docs.qgis.org/latest/en/docs/user_manual/introduction/general_tools.html#layers-panel)
...
![The Layer Properties dialog](/open-geodata-curriculum/images/es/argentina/module2/media/layer-properties.png "The Layer Properties dialog")
...
![Information properties of the NCR_admin_boundary layer](/open-geodata-curriculum/images/es/argentina/module2/media/metadata-1.png "Information properties of the NCR_admin_boundary layer")
...
![Editing some metadata](/open-geodata-curriculum/images/es/argentina/module2/media/metadata-2.png "Editing some metadata")
...
![The Information tab after editing some metadata](/open-geodata-curriculum/images/es/argentina/module2/media/metadata-3.png "The Information tab after editing some metadata")
...
![Data Source Manager](/open-geodata-curriculum/images/es/argentina/module2/media/data-source-manager-1.png "Data Source Manager")
...
2. **Cargando Vectores**
    ...
    2. Carguemos el archivo vector (sushi_osm_mendoza) que está dentro del geopackage mendoza_modulo2.gpkg. Esta es una capa de puntos de las ubicaciones del restaurantes de Sushi en Mendoza, Argentina.
        ...
        2. Fuente: Selecciona el geopackage mendoza_modulo2 usando el botón ![Search button](/open-geodata-curriculum/images/es/argentina/module2/media/data-source-manager-search.png "Search button")
        3. Haz clic en Añadir 
        4. Si hay más de 1 archivo vector dentro del geopackage, QGIS te pedirá que elijas cuáles cargar


![Loading a vector inside a GeoPackage](/open-geodata-curriculum/images/es/argentina/module2/media/data-source-manager-vector.png "Loading a vector inside a GeoPackage")
...
![Loading a raster inside a GeoPackage](/open-geodata-curriculum/images/es/argentina/module2/media/data-source-manager-raster.png "Loading a raster inside a GeoPackage")
...
4. **Carga de archivos CSV y otros archivos de texto delimitados**  
    ...
    4. Hay un archivo CSV en la carpeta de datos llamado parrillas_osm_mendoza.csv que contiene ubicaciones de puntos de los restaurantes que venden Barbacoa en la provincia de Mendoza, Argentina. Para cargarlo:
        ...
        2. Nombre de archivo: Selecciona parrillas_osm_mendoza CSV usando el botón ![Search button](/open-geodata-curriculum/images/es/argentina/module2/media/data-source-manager-search.png "Search button")
...
![Loading a CSV file](/open-geodata-curriculum/images/es/argentina/module2/media/data-source-manager-csv.png "Loading a CSV file")
...
![Layers Panel with all layers loaded](/open-geodata-curriculum/images/es/argentina/module2/media/layers-panel-2.png "Layers Panel with all layers loaded")
...
![QGIS Interface with all layers loaded](/open-geodata-curriculum/images/es/argentina/module2/media/map-canvas-1.png "QGIS Interface with all layers loaded")
...
![Adding an XYZ connection in QGIS](/open-geodata-curriculum/images/es/argentina/module2/media/xyz-1.png "Adding an XYZ connection in QGIS")
...
![PGP Basemap Tile server added to the Browser Panel](/open-geodata-curriculum/images/es/argentina/module2/media/xyz-2.png "PGP Basemap Tile server added to the Browser Panel")
...
![PGP Basemap layer loaded in QGIS](/open-geodata-curriculum/images/es/argentina/module2/media/xyz-3.png "PGP Basemap layer loaded in QGIS")
...
![Creating a new WMS/WMTS Connection](/open-geodata-curriculum/images/es/argentina/module2/media/wms-1.png "Creating a new WMS/WMTS Connection")
...
![The LiPAD 100-year Flood Hazard WMS added in the Browser Panel](/open-geodata-curriculum/images/es/argentina/module2/media/wms-2.png "The LiPAD 100-year Flood Hazard WMS added in the Browser Panel")
...
![Flood hazard map from WMS loaded in QGIS](/open-geodata-curriculum/images/es/argentina/module2/media/wms-3.png "Flood hazard map from WMS loaded in QGIS")
...
![Exporting a layer from QGIS](/open-geodata-curriculum/images/es/argentina/module2/media/exporting-layers.png "Exporting a layer from QGIS")
...
![Save Vector Layer dialog](/open-geodata-curriculum/images/es/argentina/module2/media/save-vector.png "Save Vector Layer dialog")
...
Por supuesto, también puedes hacer que la capa temporal sea permanente exportando la capa a un archivo. Haciendo clic en el ícono ![Temporary layer symbol](/open-geodata-curriculum/images/es/argentina/module2/media/symbol-temp.png "Temporary layer symbol") automáticamente abrirás un cuadro de diálogo de exportación.
...
![Connect to GeoNode](/open-geodata-curriculum/images/es/argentina/module2/media/connect-geonode.png "Connect to GeoNode")
...
3. Crea un nuevo capa geopackage con ![Create new geopakage symbol](/open-geodata-curriculum/images/es/argentina/module2/media/symbol-gpkg.png "Create new geopakage symbol") en la Barra de Herramientas Administrador de Fuentes de Datos. Nómbrala arboles, agrega el radio (número entero) y campos de especie (texto), y usa un CRS proyectado (e.g. EPSG:3857)


![New GeoPackage Layer](/open-geodata-curriculum/images/es/argentina/module2/media/virtual-1.png "New GeoPackage Layer")

Cuando aparezca un cuadro de diálogo diciendo que el archivo ya existe, seleccione Agregar nueva capa.

![GeoPackage Layer exists](/open-geodata-curriculum/images/es/argentina/module2/media/virtual-2.png "GeoPackage Layer exists")

4. Alterna la edición en el archivo haciendo clic derecho sobre él  ‣ Alternar Edición o haciendo clic en ![Toggle editing symbol](/open-geodata-curriculum/images/es/argentina/module2/media/symbol-edit.png "Toggle editing symbol") en la Barra de Herramientas de Digitalización.
5. Selecciona un área en la imagen de satélite que tenga árboles.
6. Con Edición, habilita agregar puntos a la capa haciendo clic en ![Add new point symbol](/open-geodata-curriculum/images/es/argentina/module2/media/symbol-add-point.png "[Add new point symbol") (CTRL + .).
...
![Add new trees](/open-geodata-curriculum/images/es/argentina/module2/media/virtual-3.png "Add new trees")

8. Después de agregar los puntos, no olvides guardar tus ediciones haciendo clic en ![Save edits symbol](/open-geodata-curriculum/images/es/argentina/module2/media/symbol-save-edits.png "Save edits symbol") en la Barra de Herramientas de Digitalización antes de apagar la función Edición.

![New points (trees) added](/open-geodata-curriculum/images/es/argentina/module2/media/virtual-4.png "New points (trees) added]")

9. Agrega una capa virtual haciendo clic en ![Add virtual layer symbol](/open-geodata-curriculum/images/es/argentina/module2/media/symbol-virtual.png "Add virtual layer symbol")  en la Barra de Herramientas Administrador de Fuentes de Datos.
...
![Create Virtual Layer](/open-geodata-curriculum/images/es/argentina/module2/media/virtual-5.png "Create Virtual Layer")

![Virtual layer in QGIS](/open-geodata-curriculum/images/es/argentina/module2/media/virtual-6.png "Virtual layer in QGIS")
