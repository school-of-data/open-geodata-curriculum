...
* Una introducción suave a los conceptos de SIG - [https://docs.qgis.org/latest/en/docs/gentle_gis_introduction/index.html](https://docs.qgis.org/latest/en/docs/gentle_gis_introduction/index.html)
* Guía del Usuario de QGIS- [https://docs.qgis.org/latest/en/docs/user_manual/](https://docs.qgis.org/latest/en/docs/user_manual/)
* QGIS - [https://docs.qgis.org/latest/en/docs/training_manual/index.html](https://docs.qgis.org/latest/en/docs/training_manual/index.html)
...
![True Size Of](/open-geodata-curriculum/images/es/argentina/module0/media/true-size-of.png "True Size of Countries")
...
<table>
  <tr>
   <td>     
   <img src="/open-geodata-curriculum/images/es/argentina/module0/media/blue-marble.jpg" />
...
![The earth as an orange](/open-geodata-curriculum/images/es/argentina/module0/media/dalandan.png "The earth as an orange")
...
![Conformal map projection](/open-geodata-curriculum/images/es/argentina/module0/media/conformal.png "Conformal map projection")
...
![Equal-area map projection](/open-geodata-curriculum/images/es/argentina/module0/media/authalic.png "Equal-area map projection")
...
![Equidistant map projection](/open-geodata-curriculum/images/es/argentina/module0/media/equidistant.png "Equidistant map projection")
...
![Azimuthal equidistant map projection](/open-geodata-curriculum/images/es/argentina/module0/media/az-equidistant.png "Azimuthal equidistant map projection")
...
![Cylinder as a developable surface](/open-geodata-curriculum/images/es/argentina/module0/media/cylinder.png "Cylinder as a developable surface")
...
![Cone as a developable surface](/open-geodata-curriculum/images/es/argentina/module0/media/cone.png "Cone as a developable surface")

Figura 8. Las proyecciones cónicas tienen meridianos rectos que van a un punto en los polos. Los paralelos son arcos.


![Plane as a developable surface](/open-geodata-curriculum/images/es/argentina/module0/media/plane.png "Plane as a developable surface")
...
![Aspects of a map projection](/open-geodata-curriculum/images/es/argentina/module0/media/aspects.png "Aspects of a map projection")
...
![Spatial data model](/open-geodata-curriculum/images/es/argentina/module0/media/spatial-model.png "Spatial data modelling reality")
...
![Raster data model](/open-geodata-curriculum/images/es/argentina/module0/media/raster.png "Raster data model")
...
![Vector data model](/open-geodata-curriculum/images/es/argentina/module0/media/vector.png "Vector data model")
...
![Free and Open Source Software for Geospatial (FOSS4G) applications stack](/open-geodata-curriculum/images/es/argentina/module0/media/foss4g-stack.jpeg "Free and Open Source Software for Geospatial (FOSS4G) applications stack")
