...
![alt_text](/images/es/argentina/module4/media/layer-styling.png "image_tooltip")
...
![alt_text](/images/es/argentina/module4/media/style-vector.png "image_tooltip")

![alt_text](/images/es/argentina/module4/media/style-raster.png "image_tooltip")
...
2. Agregue las dos capas vectoriales en qgis; Haga clic en el botón Agregar capa vectorial ![alt_text](/images/es/argentina/module4/media/add-vector.png "image_tooltip") o use el panel del navegador.
...
![Default render](/images/es/argentina/module4/media/default-vector-render.png "Default render")
...
![No fill rendering for the polygon](/images/es/argentina/module4/media/no-fill-render.png "No fill rendering for the polygon")
...
![Layer Properties dialogue](/images/es/argentina/module4/media/vector-style.png "Layer Properties dialogue")
...
![Final vector render](/images/es/argentina/module4/media/final-vector-render.png "Final vector render")
...
![Symbology menu](/images/es/argentina/module4/media/qgis9.png  "Symbology menu")
...
![Population density of Santa Fe, Argentina](/images/es/argentina/module4/media/hrsl-style.png "Population density of Santa Fe, Argentina")
...
![Zoomed-in map](/images/es/argentina/module4/media/zoom-in.png "Zoomed-in map")
...
![The expected initial workspace](/images/es/argentina/module4/media/initial-workspace.png "The expected initial workspace")
...
En la parte inferior del menú Simbología, hay una casilla de verificación para Draw Effects (Efectos de Dibujo). Habilitemos eso y luego hagamos clic en el botón customize effects (personalizar efectos) ![alt_text](/images/es/argentina/module4/media/customise-effects-button.png "image_tooltip") a su derecha:

![Layer Properties window and Symbology menu](/images/es/argentina/module4/media/draw-effects.png "Layer Properties window and Symbology menu")

Figura 4.11: Ventana Propiedades de la Capa y menú Simbología

3. Se abre un nuevo cuadro de diálogo Effects Properties

![Effects properties dialogue](/images/es/argentina/module4/media/new-effects-dialog.png "Effects properties dialogue")
...
![Select effect type as blur](/images/es/argentina/module4/media/blur-effect.png "Select effect type as blur")
...
![Blurry layer](/images/es/argentina/module4/media/blurry-result.png "Blurry layer")
...
![Effects properties dialogue](/images/es/argentina/module4/media/drop-shadow.png "Effects properties dialogue")
...
![Drop shadow effect](/images/es/argentina/module4/media/drop-shadow-result.png "Drop shadow effect")
...
![Centroid operation on administrative boundary layer](/images/es/argentina/module4/media/centroid.png "Centroid operation on administrative boundary layer")
